...
export module Actor {
    export interface ConstructorProperties<A extends LayoutManager = LayoutManager, B extends Content = Content>
        ...
        rotationCenterX: Graphene.Point3D;
        rotation_center_y: Graphene.Point3D;
        rotationCenterY: Graphene.Point3D;
        rotation_center_z: Graphene.Point3D;
        rotationCenterZ: Graphene.Point3D;
    ...
    implements Atk.ImplementorIface, Animatable, Container<Actor>, Scriptable
{
    ...
    get rotation_center_x(): Graphene.Point3D;
    set rotation_center_x(val: Graphene.Point3D);
    get rotationCenterX(): Graphene.Point3D;
    set rotationCenterX(val: Graphene.Point3D);
    get rotation_center_y(): Graphene.Point3D;
    set rotation_center_y(val: Graphene.Point3D);
    get rotationCenterY(): Graphene.Point3D;
    set rotationCenterY(val: Graphene.Point3D);
    get rotation_center_z(): Graphene.Point3D;
    set rotation_center_z(val: Graphene.Point3D);
    get rotationCenterZ(): Graphene.Point3D;
    set rotationCenterZ(val: Graphene.Point3D);
    ...
    connect(signal: "paint", callback: (_source: this, paint_context: PaintContext) => void): number;
    connect_after(signal: "paint", callback: (_source: this, paint_context: PaintContext) => void): number;
    ...
    connect(signal: "queue-redraw", callback: (_source: this, origin: Actor, volume: PaintVolume) => boolean): number;
    connect_after(
        signal: "queue-redraw",
...
export class Box<A extends Actor = Actor>
    extends Actor
    implements Atk.ImplementorIface, Animatable, Container<A>, Scriptable
{
    static $gtype: GObject.GType<Box>;

    constructor(properties?: Partial<Box.ConstructorProperties<A>>, ...args: any[]);
    _init(properties?: Partial<Box.ConstructorProperties<A>>, ...args: any[]): void;
...
export class DragAction extends Action {
    ...
    // Properties
    get drag_area(): Graphene.Rect;
    set drag_area(val: Graphene.Rect);
    get dragArea(): Graphene.Rect;
    set dragArea(val: Graphene.Rect);
...
export class Group<A extends Actor = Actor>
    extends Actor
    implements Atk.ImplementorIface, Animatable, Container<A>, Scriptable
{
...
export class InputDevice extends GObject.Object {
    ...
    set mapping_mode(val: InputDeviceMapping);
    get mappingMode(): InputDeviceMapping;
    set mappingMode(val: InputDeviceMapping);
    get n_axes(): number;
    get nAxes(): number;
...
export class Rectangle<A extends Actor = Actor>
    extends Actor
    implements Atk.ImplementorIface, Animatable, Container<A>, Scriptable
{
    static $gtype: GObject.GType<Rectangle>;

    constructor(properties?: Partial<Rectangle.ConstructorProperties<A>>, ...args: any[]);
    _init(properties?: Partial<Rectangle.ConstructorProperties<A>>, ...args: any[]): void;
...
export abstract class Seat extends GObject.Object {
    ...
    connect(
        signal: "tool-changed",
        callback: (_source: this, object: InputDevice, p0: InputDeviceTool) => void
    ): number;
    connect_after(
        signal: "tool-changed",
        callback: (_source: this, object: InputDevice, p0: InputDeviceTool) => void
    ): number;
    emit(signal: "tool-changed", object: InputDevice, p0: InputDeviceTool): void;
...
export module Stage {
    export interface ConstructorProperties<A extends Actor = Actor> extends Group.ConstructorProperties<A> {
        [key: string]: any;
    ...
    implements Atk.ImplementorIface, Animatable, Container<A>, Scriptable
{
    ...
    connect(signal: "after-update", callback: (_source: this) => void): number;
    connect_after(signal: "after-update", callback: (_source: this) => void): number;
    emit(signal: "after-update"): void;
    ...
    connect(signal: "before-update", callback: (_source: this) => void): number;
    connect_after(signal: "before-update", callback: (_source: this) => void): number;
    emit(signal: "before-update"): void;
    ...
    connect(signal: "paint-view", callback: (_source: this, view: StageView, redraw_clip: any | null) => void): number;
    connect_after(
        signal: "paint-view",
        callback: (_source: this, view: StageView, redraw_clip: any | null) => void
    ): number;
    emit(signal: "paint-view", view: StageView, redraw_clip: any | null): void;
    connect(
        signal: "presented",
        callback: (_source: this, frame_event: number, frame_info: any | null) => void
    ): number;
    connect_after(
        signal: "presented",
        callback: (_source: this, frame_event: number, frame_info: any | null) => void
    ): number;
    emit(signal: "presented", frame_event: number, frame_info: any | null): void;
