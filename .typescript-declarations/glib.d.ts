...
export type CopyFunc = (src: any) => any;
...
export type HookCheckMarshaller = (hook: Hook) => boolean;
...
export type HookFindFunc = (hook: Hook) => boolean;
export type HookFunc = (data?: any | null) => void;
export type HookMarshaller = (hook: Hook) => void;
export type IOFunc = (source: IOChannel, condition: IOCondition) => boolean;
...
export type NodeForeachFunc = (node: Node) => void;
export type NodeTraverseFunc = (node: Node) => boolean;
export type OptionArgFunc = (option_name: string, value: string) => boolean;
export type OptionErrorFunc = (context: OptionContext, group: OptionGroup) => void;
export type OptionParseFunc = (context: OptionContext, group: OptionGroup) => boolean;
...
export type SequenceIterCompareFunc = (a: SequenceIter, b: SequenceIter) => number;
...
export type ThreadFunc = () => any | null;
export type TranslateFunc = (str: string) => string;
export type TraverseFunc = (key?: any | null, value?: any | null) => boolean;
export type TraverseNodeFunc = (node: TreeNode) => boolean;
