...
import * as xfixes from "xfixes";

export const CURRENT_TIME: number;
export const DEFAULT_ICON_NAME: string;
export const FRAME_TILED_ANY: number;
export const FRAME_TILED_BOTTOM_EDGES: number;
export const FRAME_TILED_LEFT_EDGES: number;
export const FRAME_TILED_RIGHT_EDGES: number;
export const FRAME_TILED_TOP_EDGES: number;
...
export function get_bottom_window_group_for_display(display: Display): Clutter.Actor;
export function get_desklet_container_for_display(display: Display): Clutter.Actor;
...
export function get_x11_background_actor_for_display(display: Display): Clutter.Actor;
...
export function prefs_get_action_double_click_titlebar(): CDesktopEnums.TitlebarAction;
export function prefs_get_action_middle_click_titlebar(): CDesktopEnums.TitlebarAction;
export function prefs_get_action_right_click_titlebar(): CDesktopEnums.TitlebarAction;
export function prefs_get_action_scroll_wheel_titlebar(): CDesktopEnums.TitlebarScrollAction;
...
export function prefs_get_background_transition(): X11BackgroundTransition;
export function prefs_get_bell_sound(): string;
export function prefs_get_bring_windows_to_current_workspace(): boolean;
...
export function prefs_get_focus_mode(): CDesktopEnums.FocusMode;
export function prefs_get_focus_new_windows(): CDesktopEnums.FocusNewWindows;
...
export function prefs_get_invert_flip_direction(): boolean;
export function prefs_get_keybinding_action(name: string): KeyBindingAction;
export function prefs_get_min_win_opacity(): number;
...
export function prefs_get_mouse_button_zoom_mods(): VirtualModifier;
export function prefs_get_mouse_zoom_enabled(): boolean;
export function prefs_get_new_window_placement_mode(): PlacementMode;
...
export function prefs_get_tile_maximize(): boolean;
export function prefs_get_titlebar_font(): Pango.FontDescription;
export function prefs_get_unredirect_fullscreen_windows(): boolean;
export function prefs_get_visual_bell(): boolean;
export function prefs_get_visual_bell_type(): CDesktopEnums.VisualBellType;
export function prefs_get_workspace_cycle(): boolean;
...
export namespace PlacementMode {
    export const $gtype: GObject.GType<PlacementMode>;
}
...
export namespace TileMode {
    export const $gtype: GObject.GType<TileMode>;
}
...
export namespace X11BackgroundTransition {
    export const $gtype: GObject.GType<X11BackgroundTransition>;
}

export enum X11BackgroundTransition {
    NONE = 0,
    FADEIN = 1,
    BLEND = 2,
}

export namespace XrandrRotation {
    export const $gtype: GObject.GType<XrandrRotation>;
}

export enum XrandrRotation {
    NORMAL = 0,
    LEFT = 1,
    FLIPPED = 2,
    RIGHT = 3,
...
export namespace ListWindowsFlags {
    export const $gtype: GObject.GType<ListWindowsFlags>;
}

export enum ListWindowsFlags {
    DEFAULT = 0,
...
export class Background extends GObject.Object {
    ...
    set_gradient(
        shading_direction: CDesktopEnums.BackgroundShading,
        color: Clutter.Color,
...
export class CursorTracker extends GObject.Object {
    ...
    connect(signal: "cursor-moved", callback: (_source: this, x: number, y: number) => void): number;
    connect_after(signal: "cursor-moved", callback: (_source: this, x: number, y: number) => void): number;
...
export class Display extends GObject.Object {
    ...
    connect(
        ...
        callback: (_source: this, object: Display, p0: Window, p1: GrabOp) => void
    ): number;
    connect_after(
        signal: "grab-op-begin",
        callback: (_source: this, object: Display, p0: Window, p1: GrabOp) => void
    ): number;
    emit(signal: "grab-op-begin", object: Display, p0: Window, p1: GrabOp): void;
    connect(signal: "grab-op-end", callback: (_source: this, object: Display, p0: Window, p1: GrabOp) => void): number;
    connect_after(
        signal: "grab-op-end",
        callback: (_source: this, object: Display, p0: Window, p1: GrabOp) => void
    ): number;
    ...
    connect(signal: "zoom-scroll-in", callback: (_source: this) => void): number;
    connect_after(signal: "zoom-scroll-in", callback: (_source: this) => void): number;
    emit(signal: "zoom-scroll-in"): void;
    connect(signal: "zoom-scroll-out", callback: (_source: this) => void): number;
    connect_after(signal: "zoom-scroll-out", callback: (_source: this) => void): number;
    emit(signal: "zoom-scroll-out"): void;
...
export abstract class Window extends GObject.Object {
    ...
    get opacity(): number;
    get progress(): number;
    get progress_pulse(): boolean;
    get progressPulse(): boolean;
    get resizeable(): boolean;
    get skip_taskbar(): boolean;
    get skipTaskbar(): boolean;
    get tile_mode(): TileMode;
    get tileMode(): TileMode;
    get title(): string;
    get urgent(): boolean;
    ...
    connect(signal: "monitor-changed", callback: (_source: this, old_monitor: number) => void): number;
    connect_after(signal: "monitor-changed", callback: (_source: this, old_monitor: number) => void): number;
    emit(signal: "monitor-changed", old_monitor: number): void;
...
export module X11BackgroundActor {
    export interface ConstructorProperties<A extends Clutter.Actor = Clutter.Actor>
        extends Clutter.Actor.ConstructorProperties {
        [key: string]: any;
        dim_factor: number;
...
export class X11BackgroundActor<A extends Clutter.Actor = Clutter.Actor>
    extends Clutter.Actor
    implements Atk.ImplementorIface, Clutter.Animatable, Clutter.Container<A>, Clutter.Scriptable
{
    static $gtype: GObject.GType<X11BackgroundActor>;

    constructor(properties?: Partial<X11BackgroundActor.ConstructorProperties<A>>, ...args: any[]);
    _init(properties?: Partial<X11BackgroundActor.ConstructorProperties<A>>, ...args: any[]): void;

    // Properties
    get dim_factor(): number;
    set dim_factor(val: number);
    get dimFactor(): number;
    set dimFactor(val: number);

    // Constructors

    static new_for_display(display: Display): X11BackgroundActor;
