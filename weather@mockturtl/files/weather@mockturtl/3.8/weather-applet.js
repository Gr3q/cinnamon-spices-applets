...
*/
 ...
 // calculates sun times for a given date, latitude/longitude, and, optionally,
                // the observer height (in meters) relative to the horizon
                    ...
                    height = height || 0;
                    var i, len, time, h0, Jset, Jrise, lw = rad * -lng, phi = rad * lat, dh = observerAngle(height), d = toDays(date), n = julianCycle(d, lw), ds = approxTransit(0, lw, n), M = solarMeanAnomaly(ds), L = eclipticLongitude(M), dec = declination(L, 0), Jnoon = solarTransitJ(ds, M, L);
                    var result = {
 ...
 // calculations for moon rise/set times are based on http://www.stargazing.net/kepler/moonrise.html article
                    ...
                    var h1, h2, rise, set, a, b, xe, ye, d, roots, x1, x2, dx, hc = .133 * rad, h0 = SunCalc.getMoonPosition(t, lat, lng).altitude - hc;
 // go in 2-hour chunks, each time seeing if a 3-point quadratic curve crosses zero (which means rise or set)
                        ...
                        if (1 === roots) if (h0 < 0) rise = i + x1; else set = i + x1; else if (2 === roots) {
                            rise = i + (ye < 0 ? x2 : x1);
                            set = i + (ye < 0 ? x1 : x2);
                        }
                        if (rise && set) break;
 ...
 */        class SystemZone extends Zone {
   ...
   */
            ...
            /** @override **/            offsetName(ts, _ref) {
                let format = _ref.format, locale = _ref.locale;
        ...
        function hackyOffset(dtf, date) {
            const formatted = dtf.format(date).replace(/\u200E/g, ""), parsed = /(\d+)\/(\d+)\/(\d+) (AD|BC),? (\d+):(\d+):(\d+)/.exec(formatted), _parsed = _slicedToArray(parsed, 8), fMonth = _parsed[1], fDay = _parsed[2], fYear = _parsed[3], fadOrBc = _parsed[4], fHour = _parsed[5], fMinute = _parsed[6], fSecond = _parsed[7];
        ...
        function partsOffset(dtf, date) {
            ...
            for (let i = 0; i < formatted.length; i++) {
                const _formatted$i = formatted[i], type = _formatted$i.type, value = _formatted$i.value;
 ...
 */        class IANAZone extends Zone {
   ...
   */            static isValidZone(zone) {
            ...
            /** @override **/            offset(ts) {
                ...
                let _ref2 = dtf.formatToParts ? partsOffset(dtf, date) : hackyOffset(dtf, date), _ref3 = _slicedToArray(_ref2, 7), year = _ref3[0], month = _ref3[1], day = _ref3[2], adOrBc = _ref3[3], hour = _ref3[4], minute = _ref3[5], second = _ref3[6];
 ...
 // because we're using hour12 and https://bugs.chromium.org/p/chromium/issues/detail?id=1025564&can=2&q=%2224%3A00%22%20datetimeformat
        ...
        const _excluded = [ "base" ], _excluded2 = [ "padTo", "floor" ];
        function locale_slicedToArray(arr, i) {
            return locale_arrayWithHoles(arr) || locale_iterableToArrayLimit(arr, i) || locale_unsupportedIterableToArray(arr, i) || locale_nonIterableRest();
        }
        function locale_nonIterableRest() {
            throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
        }
        function locale_unsupportedIterableToArray(o, minLen) {
            if (!o) return;
            if ("string" === typeof o) return locale_arrayLikeToArray(o, minLen);
            var n = Object.prototype.toString.call(o).slice(8, -1);
            if ("Object" === n && o.constructor) n = o.constructor.name;
            if ("Map" === n || "Set" === n) return Array.from(o);
            if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return locale_arrayLikeToArray(o, minLen);
        }
        function locale_arrayLikeToArray(arr, len) {
            if (null == len || len > arr.length) len = arr.length;
            for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i];
            return arr2;
        }
        function locale_iterableToArrayLimit(arr, i) {
            var _i = null == arr ? null : "undefined" !== typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"];
            if (null == _i) return;
            var _arr = [];
            var _n = true;
        ...
        function locale_arrayWithHoles(arr) {
            if (Array.isArray(arr)) return arr;
        }
 ...
 // exclude `base` from the options
                        const cacheKeyOpts = _objectWithoutProperties(opts, _excluded);
        ...
        function parseLocaleString(localeStr) {
            ...
            if (-1 === uIndex) return [ localeStr ]; else {
                ...
                const _options = options, numberingSystem = _options.numberingSystem, calendar = _options.calendar;
 ...
 */        class PolyNumberFormatter {
            constructor(intl, forceSimple, opts) {
                ...
                opts.padTo, opts.floor;
                const otherOpts = _objectWithoutProperties(opts, _excluded2);
 ...
 */        class Locale {
            ...
            static create(locale, numberingSystem, outputCalendar) {
                let defaultToEN = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : false;
 ...
 // the system locale is useful for human readable strings but annoying for parsing/formatting known formats
            ...
            static fromObject() {
                let _ref = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, locale = _ref.locale, numberingSystem = _ref.numberingSystem, outputCalendar = _ref.outputCalendar;
                return Locale.create(locale, numberingSystem, outputCalendar);
            }
            constructor(locale, numbering, outputCalendar, specifiedLocale) {
                const _parseLocaleString = parseLocaleString(locale), _parseLocaleString2 = locale_slicedToArray(_parseLocaleString, 3), parsedLocale = _parseLocaleString2[0], parsedNumberingSystem = _parseLocaleString2[1], parsedOutputCalendar = _parseLocaleString2[2];
            ...
            redefaultToEN() {
                let alts = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            ...
            months(length) {
                let format = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : false;
                let defaultOK = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : true;
            ...
            meridiems() {
                let defaultOK = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : true;
            ...
            eras(length) {
                let defaultOK = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : true;
 ...
 // This is problematic. Different calendars are going to define eras totally differently. What I need is the minimum set of dates
            ...
            dtFormatter(dt) {
                let intlOpts = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
 ...
 */
        function normalizeZone(input, defaultZone) {
            if (isUndefined(input) || null === input) return defaultZone; else if (input instanceof Zone) return input; else if (isString(input)) {
                ...
                if ("default" === lowered) return defaultZone; else if ("local" === lowered || "system" === lowered) return SystemZone.instance; else if ("utc" === lowered || "gmt" === lowered) return FixedOffsetZone.utcInstance; else return FixedOffsetZone.parseSpecifier(lowered) || IANAZone.create(input);
            } else if (isNumber(input)) return FixedOffsetZone.instance(input); else if ("object" === typeof input && input.offset && "number" === typeof input.offset) 
            // This is dumb, but the instanceof check above doesn't seem to really work
            // so we're duck checking it
            return input; else return new InvalidZone(input);
        }
        // CONCATENATED MODULE: ./node_modules/luxon/src/settings.js
        let throwOnInvalid, now = () => Date.now(), defaultZone = "system", defaultLocale = null, defaultNumberingSystem = null, defaultOutputCalendar = null, twoDigitCutoffYear = 60;
        /**
 ...
 */        class Settings {
   ...
   */            static resetCaches() {
        ...
        function util_ownKeys(object, enumerableOnly) {
            var keys = Object.keys(object);
            if (Object.getOwnPropertySymbols) {
                var symbols = Object.getOwnPropertySymbols(object);
                enumerableOnly && (symbols = symbols.filter((function(sym) {
        ...
        function util_objectSpread(target) {
            for (var i = 1; i < arguments.length; i++) {
                var source = null != arguments[i] ? arguments[i] : {};
                i % 2 ? util_ownKeys(Object(source), !0).forEach((function(key) {
                    util_defineProperty(target, key, source[key]);
                })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : util_ownKeys(Object(source)).forEach((function(key) {
                    Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
                }));
            }
            return target;
 ...
 */
 ...
 // x % n but takes the sign of n instead of x
        ...
        function roundTo(number, digits) {
            let towardZero = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : false;
 ...
 // for legacy reasons, years between 0 and 99 are interpreted as 19XX; revert that
        ...
        function untruncateYear(year) {
            if (year > 99) return year; else return year > Settings.twoDigitCutoffYear ? 1900 + year : 2e3 + year;
        }
 // PARSING
                function parseZoneInfo(ts, offsetFormat, locale) {
            let timeZone = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null;
 ...
 */
        ...
        function formatRelativeTime(unit, count) {
            let numeric = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "always";
            let narrow = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : false;
            const units = {
                years: [ "year", "yr." ],
 ...
 // fall through
        ...
        function formatter_ownKeys(object, enumerableOnly) {
            var keys = Object.keys(object);
            if (Object.getOwnPropertySymbols) {
                var symbols = Object.getOwnPropertySymbols(object);
                enumerableOnly && (symbols = symbols.filter((function(sym) {
        ...
        function formatter_objectSpread(target) {
            for (var i = 1; i < arguments.length; i++) {
                var source = null != arguments[i] ? arguments[i] : {};
                i % 2 ? formatter_ownKeys(Object(source), !0).forEach((function(key) {
                    formatter_defineProperty(target, key, source[key]);
                })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : formatter_ownKeys(Object(source)).forEach((function(key) {
                    Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
                }));
            }
            return target;
        }
        function formatter_defineProperty(obj, key, value) {
            if (key in obj) Object.defineProperty(obj, key, {
                value,
                enumerable: true,
                configurable: true,
        ...
        function _createForOfIteratorHelper(o, allowArrayLike) {
            ...
            if (!it) {
                if (Array.isArray(o) || (it = formatter_unsupportedIterableToArray(o)) || allowArrayLike && o && "number" === typeof o.length) {
                    if (it) o = it;
                    var i = 0;
                    var F = function() {};
                    return {
        ...
        function formatter_unsupportedIterableToArray(o, minLen) {
            if (!o) return;
            if ("string" === typeof o) return formatter_arrayLikeToArray(o, minLen);
            var n = Object.prototype.toString.call(o).slice(8, -1);
            if ("Object" === n && o.constructor) n = o.constructor.name;
            if ("Map" === n || "Set" === n) return Array.from(o);
            if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return formatter_arrayLikeToArray(o, minLen);
        }
        function formatter_arrayLikeToArray(arr, len) {
            if (null == len || len > arr.length) len = arr.length;
            for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i];
            return arr2;
        }
        function stringifyTokens(splits, tokenToString) {
            let s = "";
            var _step, _iterator = _createForOfIteratorHelper(splits);
            try {
                for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                    const token = _step.value;
                    if (token.literal) s += token.val; else s += tokenToString(token.val);
                }
            } catch (err) {
                _iterator.e(err);
            } finally {
 ...
 */        class Formatter {
            ...
            num(n) {
                let p = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
 ...
 // falls through
            ...
            formatDurationFromString(dur, fmt) {
                ...
                }, tokens = Formatter.parseFormat(fmt), realTokens = tokens.reduce(((found, _ref) => {
                    let literal = _ref.literal, val = _ref.val;
        ...
        function regexParser_ownKeys(object, enumerableOnly) {
            var keys = Object.keys(object);
            if (Object.getOwnPropertySymbols) {
                var symbols = Object.getOwnPropertySymbols(object);
                enumerableOnly && (symbols = symbols.filter((function(sym) {
        ...
        function regexParser_objectSpread(target) {
            for (var i = 1; i < arguments.length; i++) {
                var source = null != arguments[i] ? arguments[i] : {};
                i % 2 ? regexParser_ownKeys(Object(source), !0).forEach((function(key) {
                    regexParser_defineProperty(target, key, source[key]);
                })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : regexParser_ownKeys(Object(source)).forEach((function(key) {
                    Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
                }));
            }
            return target;
        }
        function regexParser_defineProperty(obj, key, value) {
            if (key in obj) Object.defineProperty(obj, key, {
                value,
                enumerable: true,
                configurable: true,
        ...
        function regexParser_slicedToArray(arr, i) {
            return regexParser_arrayWithHoles(arr) || regexParser_iterableToArrayLimit(arr, i) || regexParser_unsupportedIterableToArray(arr, i) || regexParser_nonIterableRest();
        }
        function regexParser_nonIterableRest() {
            throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
        }
        function regexParser_unsupportedIterableToArray(o, minLen) {
            if (!o) return;
            if ("string" === typeof o) return regexParser_arrayLikeToArray(o, minLen);
            var n = Object.prototype.toString.call(o).slice(8, -1);
            if ("Object" === n && o.constructor) n = o.constructor.name;
            if ("Map" === n || "Set" === n) return Array.from(o);
            if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return regexParser_arrayLikeToArray(o, minLen);
        }
        function regexParser_arrayLikeToArray(arr, len) {
            if (null == len || len > arr.length) len = arr.length;
            for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i];
            return arr2;
        }
        function regexParser_iterableToArrayLimit(arr, i) {
            var _i = null == arr ? null : "undefined" !== typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"];
            if (null == _i) return;
            var _arr = [];
            var _n = true;
        ...
        function regexParser_arrayWithHoles(arr) {
            if (Array.isArray(arr)) return arr;
        }
        /*
 ...
 */        const ianaRegex = /[A-Za-z_+-]{1,256}(?::?\/[A-Za-z0-9_+-]{1,256}(?:\/[A-Za-z0-9_+-]{1,256})?)?/;
        ...
        function combineExtractors() {
            ...
            return m => extractors.reduce(((_ref, ex) => {
                let _ref2 = regexParser_slicedToArray(_ref, 3), mergedVals = _ref2[0], mergedZone = _ref2[1], cursor = _ref2[2];
                const _ex = ex(m, cursor), _ex2 = regexParser_slicedToArray(_ex, 3), val = _ex2[0], zone = _ex2[1], next = _ex2[2];
        ...
        function parse(s) {
            ...
            for (var _i2 = 0, _patterns = patterns; _i2 < _patterns.length; _i2++) {
                const _patterns$_i = regexParser_slicedToArray(_patterns[_i2], 2), regex = _patterns$_i[0], extractor = _patterns$_i[1];
 ...
 // ISO duration parsing
        ...
        function extractISODuration(match) {
            const _match = regexParser_slicedToArray(match, 9), s = _match[0], yearStr = _match[1], monthStr = _match[2], weekStr = _match[3], dayStr = _match[4], hourStr = _match[5], minuteStr = _match[6], secondStr = _match[7], millisecondsStr = _match[8];
            const hasNegativePrefix = "-" === s[0];
            const negativeSeconds = secondStr && "-" === secondStr[0];
            const maybeNegate = function(num) {
                let force = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : false;
                return void 0 !== num && (force || num && hasNegativePrefix) ? -num : num;
            };
            return [ {
 ...
 // http date
        ...
        function extractRFC1123Or850(match) {
            const _match3 = regexParser_slicedToArray(match, 8), weekdayStr = _match3[1], dayStr = _match3[2], monthStr = _match3[3], yearStr = _match3[4], hourStr = _match3[5], minuteStr = _match3[6], secondStr = _match3[7], result = fromStrings(weekdayStr, yearStr, monthStr, dayStr, hourStr, minuteStr, secondStr);
            return [ result, FixedOffsetZone.utcInstance ];
        }
        function extractASCII(match) {
            const _match4 = regexParser_slicedToArray(match, 8), weekdayStr = _match4[1], monthStr = _match4[2], dayStr = _match4[3], hourStr = _match4[4], minuteStr = _match4[5], secondStr = _match4[6], yearStr = _match4[7], result = fromStrings(weekdayStr, yearStr, monthStr, dayStr, hourStr, minuteStr, secondStr);
            return [ result, FixedOffsetZone.utcInstance ];
        }
 ...
 */        function parseISODate(s) {
        ...
        function duration_createForOfIteratorHelper(o, allowArrayLike) {
            var it = "undefined" !== typeof Symbol && o[Symbol.iterator] || o["@@iterator"];
            if (!it) {
                if (Array.isArray(o) || (it = duration_unsupportedIterableToArray(o)) || allowArrayLike && o && "number" === typeof o.length) {
                    if (it) o = it;
                    var i = 0;
                    var F = function() {};
                    return {
        ...
        function duration_slicedToArray(arr, i) {
            return duration_arrayWithHoles(arr) || duration_iterableToArrayLimit(arr, i) || duration_unsupportedIterableToArray(arr, i) || duration_nonIterableRest();
        }
        function duration_nonIterableRest() {
            throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
        }
        function duration_unsupportedIterableToArray(o, minLen) {
            if (!o) return;
            if ("string" === typeof o) return duration_arrayLikeToArray(o, minLen);
            var n = Object.prototype.toString.call(o).slice(8, -1);
            if ("Object" === n && o.constructor) n = o.constructor.name;
            if ("Map" === n || "Set" === n) return Array.from(o);
            if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return duration_arrayLikeToArray(o, minLen);
        }
        function duration_arrayLikeToArray(arr, len) {
            if (null == len || len > arr.length) len = arr.length;
            for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i];
            return arr2;
        }
        function duration_iterableToArrayLimit(arr, i) {
            var _i = null == arr ? null : "undefined" !== typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"];
            if (null == _i) return;
            var _arr = [];
            var _n = true;
        ...
        function duration_arrayWithHoles(arr) {
            if (Array.isArray(arr)) return arr;
        }
        function duration_ownKeys(object, enumerableOnly) {
            var keys = Object.keys(object);
            if (Object.getOwnPropertySymbols) {
                var symbols = Object.getOwnPropertySymbols(object);
                enumerableOnly && (symbols = symbols.filter((function(sym) {
        ...
        function duration_objectSpread(target) {
            for (var i = 1; i < arguments.length; i++) {
                var source = null != arguments[i] ? arguments[i] : {};
                i % 2 ? duration_ownKeys(Object(source), !0).forEach((function(key) {
                    duration_defineProperty(target, key, source[key]);
                })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : duration_ownKeys(Object(source)).forEach((function(key) {
                    Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
                }));
            }
            return target;
        }
        function duration_defineProperty(obj, key, value) {
            if (key in obj) Object.defineProperty(obj, key, {
                value,
                enumerable: true,
                configurable: true,
 ...
 // unit conversion constants
        ...
        }, lowOrderMatrix), daysInYearAccurate = 146097 / 400, daysInMonthAccurate = 146097 / 4800, accurateMatrix = duration_objectSpread({
            years: {
                quarters: 4,
                months: 12,
 ...
 // clone really means "create another instance just like this one, but with these changes"
            ...
            let clear = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : false;
            // deep merge for vals
                        const conf = {
 ...
 // NB: mutates parameters
            ...
            added = !sameSign && 0 !== toMap[toUnit] && Math.abs(raw) <= 1 ? antiTrunc(raw) : Math.trunc(raw);
            toMap[toUnit] += added;
 ...
 // Remove all properties with a value of 0 from an object
            ...
            for (var _i = 0, _Object$entries = Object.entries(vals); _i < _Object$entries.length; _i++) {
                const _Object$entries$_i = duration_slicedToArray(_Object$entries[_i], 2), key = _Object$entries$_i[0], value = _Object$entries$_i[1];
                if (0 !== value) newVals[key] = value;
            }
            return newVals;
        }
        /**
 ...
 */        class Duration {
   ...
   */            static fromISO(text, opts) {
                const _parseISODuration = parseISODuration(text), _parseISODuration2 = duration_slicedToArray(_parseISODuration, 1), parsed = _parseISODuration2[0];
   ...
   */            static fromISOTime(text, opts) {
                const _parseISOTimeOnly = parseISOTimeOnly(text), _parseISOTimeOnly2 = duration_slicedToArray(_parseISOTimeOnly, 1), parsed = _parseISOTimeOnly2[0];
                if (parsed) return Duration.fromObject(parsed, opts); else return Duration.invalid("unparsable", `the input "${text}" can't be parsed as ISO 8601`);
            }
            /**
   ...
   */            static invalid(reason) {
                let explanation = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
   ...
   */            toISO() {
                ...
                if (0 !== this.seconds || 0 !== this.milliseconds) // this will handle "floating point madness" by removing extra decimal places
   ...
   */            plus(duration) {
                ...
                var _step, _iterator = duration_createForOfIteratorHelper(orderedUnits);
                try {
                    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                        const k = _step.value;
                        if (util_hasOwnProperty(dur.values, k) || util_hasOwnProperty(this.values, k)) result[k] = dur.get(k) + this.get(k);
                    }
                } catch (err) {
                    _iterator.e(err);
                } finally {
   ...
   * @return {Duration}
   */            reconfigure() {
                let _ref = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, locale = _ref.locale, numberingSystem = _ref.numberingSystem, conversionAccuracy = _ref.conversionAccuracy, matrix = _ref.matrix;
   ...
   */            shiftTo() {
                ...
                let lastUnit;
                var _step2, _iterator2 = duration_createForOfIteratorHelper(orderedUnits);
                try {
 ...
 // anything leftover becomes the decimal for the last unit
   ...
   */            equals(other) {
                ...
                var _step3, _iterator3 = duration_createForOfIteratorHelper(orderedUnits);
                try {
        ...
        function interval_createForOfIteratorHelper(o, allowArrayLike) {
            var it = "undefined" !== typeof Symbol && o[Symbol.iterator] || o["@@iterator"];
            if (!it) {
                if (Array.isArray(o) || (it = interval_unsupportedIterableToArray(o)) || allowArrayLike && o && "number" === typeof o.length) {
                    if (it) o = it;
                    var i = 0;
                    var F = function() {};
                    return {
        ...
        function interval_slicedToArray(arr, i) {
            return interval_arrayWithHoles(arr) || interval_iterableToArrayLimit(arr, i) || interval_unsupportedIterableToArray(arr, i) || interval_nonIterableRest();
        }
        function interval_nonIterableRest() {
            throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
        }
        function interval_unsupportedIterableToArray(o, minLen) {
            if (!o) return;
            if ("string" === typeof o) return interval_arrayLikeToArray(o, minLen);
            var n = Object.prototype.toString.call(o).slice(8, -1);
            if ("Object" === n && o.constructor) n = o.constructor.name;
            if ("Map" === n || "Set" === n) return Array.from(o);
            if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return interval_arrayLikeToArray(o, minLen);
        }
        function interval_arrayLikeToArray(arr, len) {
            if (null == len || len > arr.length) len = arr.length;
            for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i];
            return arr2;
        }
        function interval_iterableToArrayLimit(arr, i) {
            var _i = null == arr ? null : "undefined" !== typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"];
            if (null == _i) return;
            var _arr = [];
            var _n = true;
        ...
        function interval_arrayWithHoles(arr) {
            if (Array.isArray(arr)) return arr;
        }
 ...
 */        class Interval {
   ...
   * @return {Interval}
   */            static fromISO(text, opts) {
                const _split = (text || "").split("/", 2), _split2 = interval_slicedToArray(_split, 2), s = _split2[0], e = _split2[1];
                if (s && e) {
   ...
   * @return {number}
   */            length() {
                let unit = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "milliseconds";
   ...
   * @return {Interval}
   */            set() {
                let _ref = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, start = _ref.start, end = _ref.end;
                if (!this.isValid) return this;
   ...
   */            static merge(intervals) {
                const _intervals$sort$reduc = intervals.sort(((a, b) => a.s - b.s)).reduce(((_ref2, item) => {
                    let _ref3 = interval_slicedToArray(_ref2, 2), sofar = _ref3[0], current = _ref3[1];
                ...
                }), [ [], null ]), _intervals$sort$reduc2 = interval_slicedToArray(_intervals$sort$reduc, 2), found = _intervals$sort$reduc2[0], final = _intervals$sort$reduc2[1];
   ...
   */            static xor(intervals) {
                ...
                var _step, _iterator = interval_createForOfIteratorHelper(arr);
                try {
                    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                        const i = _step.value;
   ...
   * @return {string}
   */            toLocaleString() {
                let formatOpts = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : DATE_SHORT;
                let opts = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
   ...
   * @return {string}
   */            toFormat(dateFormat) {
                let _ref4 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, _ref4$separator = _ref4.separator, separator = void 0 === _ref4$separator ? " – " : _ref4$separator;
                if (!this.isValid) return interval_INVALID;
 ...
 */
   ...
   */
            static hasDST() {
                let zone = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Settings.defaultZone;
   ...
   * @return {Array}
   */            static months() {
                let length = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "long";
                let _ref = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, _ref$locale = _ref.locale, locale = void 0 === _ref$locale ? null : _ref$locale, _ref$numberingSystem = _ref.numberingSystem, numberingSystem = void 0 === _ref$numberingSystem ? null : _ref$numberingSystem, _ref$locObj = _ref.locObj, locObj = void 0 === _ref$locObj ? null : _ref$locObj, _ref$outputCalendar = _ref.outputCalendar, outputCalendar = void 0 === _ref$outputCalendar ? "gregory" : _ref$outputCalendar;
   ...
   */            static monthsFormat() {
                let length = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "long";
                let _ref2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, _ref2$locale = _ref2.locale, locale = void 0 === _ref2$locale ? null : _ref2$locale, _ref2$numberingSystem = _ref2.numberingSystem, numberingSystem = void 0 === _ref2$numberingSystem ? null : _ref2$numberingSystem, _ref2$locObj = _ref2.locObj, locObj = void 0 === _ref2$locObj ? null : _ref2$locObj, _ref2$outputCalendar = _ref2.outputCalendar, outputCalendar = void 0 === _ref2$outputCalendar ? "gregory" : _ref2$outputCalendar;
   ...
   */            static weekdays() {
                let length = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "long";
                let _ref3 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, _ref3$locale = _ref3.locale, locale = void 0 === _ref3$locale ? null : _ref3$locale, _ref3$numberingSystem = _ref3.numberingSystem, numberingSystem = void 0 === _ref3$numberingSystem ? null : _ref3$numberingSystem, _ref3$locObj = _ref3.locObj, locObj = void 0 === _ref3$locObj ? null : _ref3$locObj;
   ...
   */            static weekdaysFormat() {
                let length = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "long";
                let _ref4 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, _ref4$locale = _ref4.locale, locale = void 0 === _ref4$locale ? null : _ref4$locale, _ref4$numberingSystem = _ref4.numberingSystem, numberingSystem = void 0 === _ref4$numberingSystem ? null : _ref4$numberingSystem, _ref4$locObj = _ref4.locObj, locObj = void 0 === _ref4$locObj ? null : _ref4$locObj;
   ...
   * @return {Array}
   */            static meridiems() {
                let _ref5 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, _ref5$locale = _ref5.locale, locale = void 0 === _ref5$locale ? null : _ref5$locale;
   ...
   * @return {Array}
   */            static eras() {
                let length = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "short";
                let _ref6 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, _ref6$locale = _ref6.locale, locale = void 0 === _ref6$locale ? null : _ref6$locale;
   ...
   */            static features() {
        ...
        function diff_slicedToArray(arr, i) {
            return diff_arrayWithHoles(arr) || diff_iterableToArrayLimit(arr, i) || diff_unsupportedIterableToArray(arr, i) || diff_nonIterableRest();
        }
        function diff_nonIterableRest() {
            throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
        }
        function diff_unsupportedIterableToArray(o, minLen) {
            if (!o) return;
            if ("string" === typeof o) return diff_arrayLikeToArray(o, minLen);
            var n = Object.prototype.toString.call(o).slice(8, -1);
            if ("Object" === n && o.constructor) n = o.constructor.name;
            if ("Map" === n || "Set" === n) return Array.from(o);
            if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return diff_arrayLikeToArray(o, minLen);
        }
        function diff_arrayLikeToArray(arr, len) {
            if (null == len || len > arr.length) len = arr.length;
            for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i];
            return arr2;
        }
        function diff_iterableToArrayLimit(arr, i) {
            var _i = null == arr ? null : "undefined" !== typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"];
            if (null == _i) return;
            var _arr = [];
            var _n = true;
        ...
        function diff_arrayWithHoles(arr) {
            if (Array.isArray(arr)) return arr;
        }
        ...
        function highOrderDiffs(cursor, later, units) {
            const differs = [ [ "years", (a, b) => b.year - a.year ], [ "quarters", (a, b) => b.quarter - a.quarter + 4 * (b.year - a.year) ], [ "months", (a, b) => b.month - a.month + 12 * (b.year - a.year) ], [ "weeks", (a, b) => {
            ...
            for (var _i = 0, _differs = differs; _i < _differs.length; _i++) {
                const _differs$_i = diff_slicedToArray(_differs[_i], 2), unit = _differs$_i[0], differ = _differs$_i[1];
        ...
        /* harmony default export */        function diff(earlier, later, units, opts) {
            let _highOrderDiffs = highOrderDiffs(earlier, later, units), _highOrderDiffs2 = diff_slicedToArray(_highOrderDiffs, 4), cursor = _highOrderDiffs2[0], results = _highOrderDiffs2[1], highWater = _highOrderDiffs2[2], lowestOrder = _highOrderDiffs2[3];
        ...
        function digits_slicedToArray(arr, i) {
            return digits_arrayWithHoles(arr) || digits_iterableToArrayLimit(arr, i) || digits_unsupportedIterableToArray(arr, i) || digits_nonIterableRest();
        }
        function digits_nonIterableRest() {
            throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
        }
        function digits_unsupportedIterableToArray(o, minLen) {
            if (!o) return;
            if ("string" === typeof o) return digits_arrayLikeToArray(o, minLen);
            var n = Object.prototype.toString.call(o).slice(8, -1);
            if ("Object" === n && o.constructor) n = o.constructor.name;
            if ("Map" === n || "Set" === n) return Array.from(o);
            if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return digits_arrayLikeToArray(o, minLen);
        }
        function digits_arrayLikeToArray(arr, len) {
            if (null == len || len > arr.length) len = arr.length;
            for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i];
            return arr2;
        }
        function digits_iterableToArrayLimit(arr, i) {
            var _i = null == arr ? null : "undefined" !== typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"];
            if (null == _i) return;
            var _arr = [];
            var _n = true;
        ...
        function digits_arrayWithHoles(arr) {
            if (Array.isArray(arr)) return arr;
        }
            ...
            if (isNaN(value)) {
                ...
                for (let i = 0; i < str.length; i++) {
                    ...
                    if (-1 !== str[i].search(numberingSystems.hanidec)) value += hanidecChars.indexOf(str[i]); else for (const key in numberingSystemsUTF16) {
                        const _numberingSystemsUTF = digits_slicedToArray(numberingSystemsUTF16[key], 2), min = _numberingSystemsUTF[0], max = _numberingSystemsUTF[1];
        ...
        function digitRegex(_ref) {
            ...
            let append = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "";
            return new RegExp(`${numberingSystems[numberingSystem || "latn"]}${append}`);
        }
        // CONCATENATED MODULE: ./node_modules/luxon/src/impl/tokenParser.js
        function tokenParser_slicedToArray(arr, i) {
            return tokenParser_arrayWithHoles(arr) || tokenParser_iterableToArrayLimit(arr, i) || tokenParser_unsupportedIterableToArray(arr, i) || tokenParser_nonIterableRest();
        }
        function tokenParser_nonIterableRest() {
            throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
        }
        function tokenParser_unsupportedIterableToArray(o, minLen) {
            if (!o) return;
            if ("string" === typeof o) return tokenParser_arrayLikeToArray(o, minLen);
            var n = Object.prototype.toString.call(o).slice(8, -1);
            if ("Object" === n && o.constructor) n = o.constructor.name;
            if ("Map" === n || "Set" === n) return Array.from(o);
            if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return tokenParser_arrayLikeToArray(o, minLen);
        }
        function tokenParser_arrayLikeToArray(arr, len) {
            if (null == len || len > arr.length) len = arr.length;
            for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i];
            return arr2;
        }
        function tokenParser_iterableToArrayLimit(arr, i) {
            var _i = null == arr ? null : "undefined" !== typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"];
            if (null == _i) return;
            var _arr = [];
            var _n = true;
        ...
        function tokenParser_arrayWithHoles(arr) {
            if (Array.isArray(arr)) return arr;
        }
        const MISSING_FTP = "missing Intl.DateTimeFormat.formatToParts support";
        function intUnit(regex) {
            let post = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : i => i;
            return {
                regex,
                deser: _ref => {
                    let _ref2 = tokenParser_slicedToArray(_ref, 1), s = _ref2[0];
        ...
        function oneOf(strings, startIndex) {
            if (null === strings) return null; else return {
                ...
                deser: _ref3 => {
                    let _ref4 = tokenParser_slicedToArray(_ref3, 1), s = _ref4[0];
        ...
        function offset(regex, groups) {
            return {
                regex,
                deser: _ref5 => {
                    let _ref6 = tokenParser_slicedToArray(_ref5, 3), h = _ref6[1], m = _ref6[2];
        ...
        function simple(regex) {
            return {
                regex,
                deser: _ref7 => {
                    let _ref8 = tokenParser_slicedToArray(_ref7, 1), s = _ref8[0];
                    return s;
                }
            };
        }
        ...
        function unitForToken(token, loc) {
            const one = digitRegex(loc), two = digitRegex(loc, "{2}"), three = digitRegex(loc, "{3}"), four = digitRegex(loc, "{4}"), six = digitRegex(loc, "{6}"), oneOrTwo = digitRegex(loc, "{1,2}"), oneToThree = digitRegex(loc, "{1,3}"), oneToSix = digitRegex(loc, "{1,6}"), oneToNine = digitRegex(loc, "{1,9}"), twoToFour = digitRegex(loc, "{2,4}"), fourToSix = digitRegex(loc, "{4,6}"), literal = t => ({
                ...
                deser: _ref9 => {
                    let _ref10 = tokenParser_slicedToArray(_ref9, 1), s = _ref10[0];
                    return s;
                },
                literal: true
            }), unitate = t => {
        ...
        function tokenForPart(part, formatOpts) {
            const type = part.type, value = part.value;
 ...
 */        function explainFromTokens(locale, input, format) {
            ...
            if (disqualifyingUnit) return {
                ...
                const _buildRegex = buildRegex(units), _buildRegex2 = tokenParser_slicedToArray(_buildRegex, 2), regexString = _buildRegex2[0], handlers = _buildRegex2[1], regex = RegExp(regexString, "i"), _match = match(input, regex, handlers), _match2 = tokenParser_slicedToArray(_match, 2), rawMatches = _match2[0], matches = _match2[1], _ref11 = matches ? dateTimeFromMatches(matches) : [ null, null, void 0 ], _ref12 = tokenParser_slicedToArray(_ref11, 3), result = _ref12[0], zone = _ref12[1], specificOffset = _ref12[2];
        ...
        function parseFromTokens(locale, input, format) {
            const _explainFromTokens = explainFromTokens(locale, input, format), result = _explainFromTokens.result, zone = _explainFromTokens.zone, specificOffset = _explainFromTokens.specificOffset, invalidReason = _explainFromTokens.invalidReason;
        ...
        function conversions_ownKeys(object, enumerableOnly) {
            var keys = Object.keys(object);
            if (Object.getOwnPropertySymbols) {
                var symbols = Object.getOwnPropertySymbols(object);
                enumerableOnly && (symbols = symbols.filter((function(sym) {
        ...
        function conversions_objectSpread(target) {
            for (var i = 1; i < arguments.length; i++) {
                var source = null != arguments[i] ? arguments[i] : {};
                i % 2 ? conversions_ownKeys(Object(source), !0).forEach((function(key) {
                    conversions_defineProperty(target, key, source[key]);
                })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : conversions_ownKeys(Object(source)).forEach((function(key) {
                    Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
                }));
            }
            return target;
        }
        function conversions_defineProperty(obj, key, value) {
            if (key in obj) Object.defineProperty(obj, key, {
                value,
                enumerable: true,
                configurable: true,
 ...
 */        function gregorianToWeek(gregObj) {
            const year = gregObj.year, month = gregObj.month, day = gregObj.day, ordinal = computeOrdinal(year, month, day), weekday = dayOfWeek(year, month, day);
        ...
        function weekToGregorian(weekData) {
            const weekYear = weekData.weekYear, weekNumber = weekData.weekNumber, weekday = weekData.weekday, weekdayOfJan4 = dayOfWeek(weekYear, 1, 4), yearInDays = daysInYear(weekYear);
            ...
            const _uncomputeOrdinal = uncomputeOrdinal(year, ordinal), month = _uncomputeOrdinal.month, day = _uncomputeOrdinal.day;
            return conversions_objectSpread({
                year,
                month,
                day
        ...
        function gregorianToOrdinal(gregData) {
            const year = gregData.year, month = gregData.month, day = gregData.day;
        ...
        function ordinalToGregorian(ordinalData) {
            const year = ordinalData.year, ordinal = ordinalData.ordinal;
            const _uncomputeOrdinal2 = uncomputeOrdinal(year, ordinal), month = _uncomputeOrdinal2.month, day = _uncomputeOrdinal2.day;
            return conversions_objectSpread({
                year,
                month,
                day
        ...
        function hasInvalidTimeData(obj) {
            const hour = obj.hour, minute = obj.minute, second = obj.second, millisecond = obj.millisecond;
        ...
        function datetime_createForOfIteratorHelper(o, allowArrayLike) {
            var it = "undefined" !== typeof Symbol && o[Symbol.iterator] || o["@@iterator"];
            if (!it) {
                if (Array.isArray(o) || (it = datetime_unsupportedIterableToArray(o)) || allowArrayLike && o && "number" === typeof o.length) {
                    if (it) o = it;
                    var i = 0;
                    var F = function() {};
                    return {
        ...
        function datetime_unsupportedIterableToArray(o, minLen) {
            if (!o) return;
            if ("string" === typeof o) return datetime_arrayLikeToArray(o, minLen);
            var n = Object.prototype.toString.call(o).slice(8, -1);
            if ("Object" === n && o.constructor) n = o.constructor.name;
            if ("Map" === n || "Set" === n) return Array.from(o);
            if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return datetime_arrayLikeToArray(o, minLen);
        }
        ...
        function datetime_ownKeys(object, enumerableOnly) {
            var keys = Object.keys(object);
            if (Object.getOwnPropertySymbols) {
                var symbols = Object.getOwnPropertySymbols(object);
                enumerableOnly && (symbols = symbols.filter((function(sym) {
        ...
        function datetime_objectSpread(target) {
            for (var i = 1; i < arguments.length; i++) {
                var source = null != arguments[i] ? arguments[i] : {};
                i % 2 ? datetime_ownKeys(Object(source), !0).forEach((function(key) {
                    datetime_defineProperty(target, key, source[key]);
                })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : datetime_ownKeys(Object(source)).forEach((function(key) {
                    Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
                }));
            }
            return target;
        }
        function datetime_defineProperty(obj, key, value) {
            if (key in obj) Object.defineProperty(obj, key, {
                value,
                enumerable: true,
                configurable: true,
 ...
 // create a new DT instance by adding a duration, adjusting for DSTs
            ...
            const oPre = inst.o, year = inst.c.year + Math.trunc(dur.years), month = inst.c.month + Math.trunc(dur.months) + 3 * Math.trunc(dur.quarters), c = datetime_objectSpread(datetime_objectSpread({}, inst.c), {}, {
                year,
                month,
            ...
            let _fixOffset = fixOffset(localTS, oPre, inst.zone), _fixOffset2 = datetime_slicedToArray(_fixOffset, 2), ts = _fixOffset2[0], o = _fixOffset2[1];
            if (0 !== millisToAdd) {
                ts += millisToAdd;
 ...
 // helper useful in turning the results of parsing into real dates
        // by handling the zone options
            ...
            const setZone = opts.setZone, zone = opts.zone;
            if (parsed && 0 !== Object.keys(parsed).length) {
                const interpretationZone = parsedZone || zone, inst = DateTime.fromObject(parsed, datetime_objectSpread(datetime_objectSpread({}, opts), {}, {
 ...
 // if you want to output a technical format (e.g. RFC 2822), this helper
        // helps handle the details
            ...
            let allowZ = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : true;
 ...
 // assume we have the higher-order units
                ...
                var _step, _iterator = datetime_createForOfIteratorHelper(datetime_orderedUnits);
                try {
                    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                        const u = _step.value;
        ...
        function diffRelative(start, end, opts) {
            ...
            var _step2, _iterator2 = datetime_createForOfIteratorHelper(opts.units);
            try {
                for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
 ...
 */        class DateTime {
   ...
   * @return {DateTime}
   */            static local() {
                const _lastOpts = lastOpts(arguments), _lastOpts2 = datetime_slicedToArray(_lastOpts, 2), opts = _lastOpts2[0], args = _lastOpts2[1], _args = datetime_slicedToArray(args, 7), year = _args[0], month = _args[1], day = _args[2], hour = _args[3], minute = _args[4], second = _args[5], millisecond = _args[6];
                return quickDT({
                    year,
                    month,
                    day,
   ...
   * @return {DateTime}
   */            static utc() {
                const _lastOpts3 = lastOpts(arguments), _lastOpts4 = datetime_slicedToArray(_lastOpts3, 2), opts = _lastOpts4[0], args = _lastOpts4[1], _args2 = datetime_slicedToArray(args, 7), year = _args2[0], month = _args2[1], day = _args2[2], hour = _args2[3], minute = _args2[4], second = _args2[5], millisecond = _args2[6];
   ...
   */            static fromMillis(milliseconds) {
                let options = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                if (!isNumber(milliseconds)) throw new InvalidArgumentError(`fromMillis requires a numerical input, but received a ${typeof milliseconds} with value ${milliseconds}`); else if (milliseconds < -MAX_DATE || milliseconds > MAX_DATE) 
                // this isn't perfect because because we can still end up out of range because of additional shifting, but it's a start
                return DateTime.invalid("Timestamp out of range"); else return new DateTime({
                    ts: milliseconds,
 ...
 // set default values for missing stuff
                ...
                var _step3, _iterator3 = datetime_createForOfIteratorHelper(units);
                try {
                    for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
                        const u = _step3.value;
 ...
 // compute the actual time
                                const gregorian = useWeekData ? weekToGregorian(normalized) : containsOrdinal ? ordinalToGregorian(normalized) : normalized, _objToTS3 = objToTS(gregorian, offsetProvis, zoneToUse), _objToTS4 = datetime_slicedToArray(_objToTS3, 2), tsFinal = _objToTS4[0], offsetFinal = _objToTS4[1], inst = new DateTime({
                    ts: tsFinal,
                    zone: zoneToUse,
                    o: offsetFinal,
                    loc
 ...
 // gregorian data + weekday serves only to validate
   ...
   */            static fromISO(text) {
                let opts = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                const _parseISODate = parseISODate(text), _parseISODate2 = datetime_slicedToArray(_parseISODate, 2), vals = _parseISODate2[0], parsedZone = _parseISODate2[1];
   ...
   */            static fromRFC2822(text) {
                let opts = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                const _parseRFC2822Date = parseRFC2822Date(text), _parseRFC2822Date2 = datetime_slicedToArray(_parseRFC2822Date, 2), vals = _parseRFC2822Date2[0], parsedZone = _parseRFC2822Date2[1];
   ...
   */            static fromHTTP(text) {
                let opts = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                const _parseHTTPDate = parseHTTPDate(text), _parseHTTPDate2 = datetime_slicedToArray(_parseHTTPDate, 2), vals = _parseHTTPDate2[0], parsedZone = _parseHTTPDate2[1];
   ...
   */            static fromFormat(text, fmt) {
                ...
                const _opts$locale = opts.locale, locale = void 0 === _opts$locale ? null : _opts$locale, _opts$numberingSystem = opts.numberingSystem, numberingSystem = void 0 === _opts$numberingSystem ? null : _opts$numberingSystem, localeToUse = Locale.fromOpts({
                    locale,
                    numberingSystem,
                    defaultToEN: true
                }), _parseFromTokens = parseFromTokens(localeToUse, text, fmt), _parseFromTokens2 = datetime_slicedToArray(_parseFromTokens, 4), vals = _parseFromTokens2[0], parsedZone = _parseFromTokens2[1], specificOffset = _parseFromTokens2[2], invalid = _parseFromTokens2[3];
   ...
   */            static fromSQL(text) {
                let opts = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                const _parseSQL = parseSQL(text), _parseSQL2 = datetime_slicedToArray(_parseSQL, 2), vals = _parseSQL2[0], parsedZone = _parseSQL2[1];
   ...
   */            static parseFormatForOpts(formatOpts) {
                let localeOpts = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
   ...
   */            resolvedLocaleOptions() {
                let opts = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                const _Formatter$create$res = Formatter.create(this.loc.clone(opts), opts).resolvedOptions(this), locale = _Formatter$create$res.locale, numberingSystem = _Formatter$create$res.numberingSystem, calendar = _Formatter$create$res.calendar;
                return {
                    locale,
                    numberingSystem,
   ...
   * @return {DateTime}
   */            setZone(zone) {
                let _ref2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, _ref2$keepLocalTime = _ref2.keepLocalTime, keepLocalTime = void 0 === _ref2$keepLocalTime ? false : _ref2$keepLocalTime, _ref2$keepCalendarTim = _ref2.keepCalendarTime, keepCalendarTime = void 0 === _ref2$keepCalendarTim ? false : _ref2$keepCalendarTim;
   ...
   * @return {DateTime}
   */            reconfigure() {
                let _ref3 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, locale = _ref3.locale, numberingSystem = _ref3.numberingSystem, outputCalendar = _ref3.outputCalendar;
                const loc = this.loc.clone({
                    locale,
                    numberingSystem,
                    outputCalendar
   ...
   */            set(values) {
                ...
                if (containsGregorMD && containsOrdinal) throw new ConflictingSpecificationError("Can't mix ordinal dates with month/day");
                let mixed;
                if (settingWeekStuff) mixed = weekToGregorian(datetime_objectSpread(datetime_objectSpread({}, gregorianToWeek(this.c)), normalized)); else if (!isUndefined(normalized.ordinal)) mixed = ordinalToGregorian(datetime_objectSpread(datetime_objectSpread({}, gregorianToOrdinal(this.c)), normalized)); else {
 ...
 // if we didn't set the day but we ended up on an overflow date,
                ...
                const _objToTS7 = objToTS(mixed, this.o, this.zone), _objToTS8 = datetime_slicedToArray(_objToTS7, 2), ts = _objToTS8[0], o = _objToTS8[1];
                return datetime_clone(this, {
                    ts,
                    o
                });
   ...
   * @return {string}
   */            toISO() {
                let _ref4 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, _ref4$format = _ref4.format, format = void 0 === _ref4$format ? "extended" : _ref4$format, _ref4$suppressSeconds = _ref4.suppressSeconds, suppressSeconds = void 0 === _ref4$suppressSeconds ? false : _ref4$suppressSeconds, _ref4$suppressMillise = _ref4.suppressMilliseconds, suppressMilliseconds = void 0 === _ref4$suppressMillise ? false : _ref4$suppressMillise, _ref4$includeOffset = _ref4.includeOffset, includeOffset = void 0 === _ref4$includeOffset ? true : _ref4$includeOffset, _ref4$extendedZone = _ref4.extendedZone, extendedZone = void 0 === _ref4$extendedZone ? false : _ref4$extendedZone;
                if (!this.isValid) return null;
   ...
   * @return {string}
   */            toISODate() {
                let _ref5 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, _ref5$format = _ref5.format, format = void 0 === _ref5$format ? "extended" : _ref5$format;
                if (!this.isValid) return null;
   ...
   * @return {string}
   */            toISOTime() {
                let _ref6 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, _ref6$suppressMillise = _ref6.suppressMilliseconds, suppressMilliseconds = void 0 === _ref6$suppressMillise ? false : _ref6$suppressMillise, _ref6$suppressSeconds = _ref6.suppressSeconds, suppressSeconds = void 0 === _ref6$suppressSeconds ? false : _ref6$suppressSeconds, _ref6$includeOffset = _ref6.includeOffset, includeOffset = void 0 === _ref6$includeOffset ? true : _ref6$includeOffset, _ref6$includePrefix = _ref6.includePrefix, includePrefix = void 0 === _ref6$includePrefix ? false : _ref6$includePrefix, _ref6$extendedZone = _ref6.extendedZone, extendedZone = void 0 === _ref6$extendedZone ? false : _ref6$extendedZone, _ref6$format = _ref6.format, format = void 0 === _ref6$format ? "extended" : _ref6$format;
                if (!this.isValid) return null;
   ...
   * @return {string}
   */            toSQLTime() {
                let _ref7 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, _ref7$includeOffset = _ref7.includeOffset, includeOffset = void 0 === _ref7$includeOffset ? true : _ref7$includeOffset, _ref7$includeZone = _ref7.includeZone, includeZone = void 0 === _ref7$includeZone ? false : _ref7$includeZone, _ref7$includeOffsetSp = _ref7.includeOffsetSpace, includeOffsetSpace = void 0 === _ref7$includeOffsetSp ? true : _ref7$includeOffsetSp;
   ...
   */
            diff(otherDateTime) {
                let unit = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "milliseconds";
                let opts = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
   ...
   */
            static fromFormatExplain(text, fmt) {
                ...
                const _options$locale = options.locale, locale = void 0 === _options$locale ? null : _options$locale, _options$numberingSys = options.numberingSystem, numberingSystem = void 0 === _options$numberingSys ? null : _options$numberingSys, localeToUse = Locale.fromOpts({
                    locale,
                    numberingSystem,
                    defaultToEN: true
                });
 ...
 */        function friendlyDateTime(dateTimeish) {
        ...
        function _(str, args) {
            ...
            if (result === str && "" === result) result = imports.gettext.gettext(str);
            if (!!args) result = format(result, args);
            return result;
        }
        function format(str, args) {
            for (const key in args) str = str.replace(new RegExp("\\{" + key + "\\}"), args[key]);
            return str;
        }
        function UnitToUnicode(unit) {
            return "fahrenheit" == unit ? "°F" : "°C";
        }
        function GenerateLocationText(weather, config) {
            let location = "";
            if (null != weather.location.city && null != weather.location.country) location = weather.location.city + ", " + weather.location.country; else location = Math.round(1e4 * weather.coord.lat) / 1e4 + ", " + Math.round(1e4 * weather.coord.lon) / 1e4;
            if (NotEmpty(config._locationLabelOverride)) location = InjectValues(config._locationLabelOverride, weather, config);
            return location;
        }
        function InjectValues(text, weather, config) {
            ...
            return text.replace(/{t}/g, null !== (_a = TempToUserConfig(weather.temperature, config, false)) && void 0 !== _a ? _a : "").replace(/{u}/g, UnitToUnicode(config.TemperatureUnit)).replace(/{c}/g, weather.condition.main).replace(/{c_long}/g, weather.condition.description).replace(/{dew_point}/g, null !== (_b = TempToUserConfig(weather.dewPoint, config, false)) && void 0 !== _b ? _b : "").replace(/{humidity}/g, null !== (_d = null === (_c = weather.humidity) || void 0 === _c ? void 0 : _c.toString()) && void 0 !== _d ? _d : "").replace(/{pressure}/g, null != weather.pressure ? PressToUserUnits(weather.pressure, config._pressureUnit).toString() : "").replace(/{pressure_unit}/g, config._pressureUnit).replace(/{extra_value}/g, weather.extra_field ? ExtraFieldToUserUnits(weather.extra_field, config) : "").replace(/{extra_name}/g, weather.extra_field ? weather.extra_field.name : "").replace(/{wind_speed}/g, null != weather.wind.speed ? MPStoUserUnits(weather.wind.speed, config.WindSpeedUnit) : "").replace(/{wind_dir}/g, null != weather.wind.degree ? CompassDirectionText(weather.wind.degree) : "").replace(/{city}/g, null !== (_e = weather.location.city) && void 0 !== _e ? _e : "").replace(/{country}/g, null !== (_f = weather.location.country) && void 0 !== _f ? _f : "").replace(/{search_entry}/g, null !== (_h = null === (_g = config.CurrentLocation) || void 0 === _g ? void 0 : _g.entryText) && void 0 !== _h ? _h : "").replace(/{last_updated}/g, lastUpdatedTime);
        }
        function CapitalizeFirstLetter(description) {
            if (void 0 == description || null == description) return "";
        ...
        function NormalizeTimezone(tz) {
            if (!tz || "" == tz || "UTC" == tz) tz = void 0;
            return tz;
        }
        function GetDayName(date, options = {}) {
            const {locale = null, showDate = false, tz = void 0, short = false, useTodayTomorrow = true} = options;
            const params = {
                weekday: short ? "short" : "long"
            };
            params.timeZone = NormalizeTimezone(tz);
            if (showDate) params.day = "numeric";
            let now = DateTime.utc();
            let tomorrow = DateTime.utc().plus({
                days: 1
            });
            if (!!tz) {
                now = now.setZone(tz);
            ...
            if (useTodayTomorrow) if (date.hasSame(now, "day") || date.hasSame(tomorrow, "day")) delete params.weekday;
        ...
        function GetHoursMinutes(date, locale, hours24Format, tz, onlyHours = false) {
            ...
            params.timeZone = NormalizeTimezone(tz);
            if (!onlyHours) params.minute = "2-digit";
            if (!!tz) date = date.setZone(tz);
            if (!!locale) date = date.setLocale(locale);
        ...
        function AwareDateString(date, locale, hours24Format, tz) {
            ...
            if (!date.hasSame(now, "year")) params.year = "numeric";
            params.timeZone = NormalizeTimezone(tz);
            if (!!locale) date = date.setLocale(locale);
            return date.toLocaleString(params);
        }
        ...
        function ProcessCondition(condition, shouldTranslate) {
            ...
            if (shouldTranslate) condition = _(condition);
            return condition;
        }
        ...
        function PercentToLocale(humidity, locale, withUnit = true) {
            if (withUnit) return (humidity / 100).toLocaleString(null !== locale && void 0 !== locale ? locale : void 0, {
                style: "percent"
            }); else return Math.round(humidity).toString();
        }
        ...
        function MPStoUserUnits(mps, units) {
            switch (units) {
              ...
              case "m/s":
                return (Math.round(10 * mps) / 10).toString();

              case "Knots":
                return Math.round(mps * WEATHER_CONV_KNOTS_IN_MPS).toString();

              case "Beaufort":
                if (mps < .5) return "0 (" + _("Calm") + ")";
                if (mps < 1.5) return "1 (" + _("Light air") + ")";
                if (mps < 3.3) return "2 (" + _("Light breeze") + ")";
                if (mps < 5.5) return "3 (" + _("Gentle breeze") + ")";
                if (mps < 7.9) return "4 (" + _("Moderate breeze") + ")";
                if (mps < 10.7) return "5 (" + _("Fresh breeze") + ")";
                if (mps < 13.8) return "6 (" + _("Strong breeze") + ")";
                if (mps < 17.1) return "7 (" + _("Near gale") + ")";
                if (mps < 20.7) return "8 (" + _("Gale") + ")";
                if (mps < 24.4) return "9 (" + _("Strong gale") + ")";
                if (mps < 28.4) return "10 (" + _("Storm") + ")";
                if (mps < 32.6) return "11 (" + _("Violent storm") + ")";
        ...
        function TempToUserConfig(kelvin, config, withUnit = true) {
            if (null == kelvin) return null;
            let temp = "celsius" == config.TemperatureUnit ? KelvinToCelsius(kelvin) : KelvinToFahrenheit(kelvin);
            temp = RussianTransform(temp, config._tempRussianStyle);
            if (withUnit) temp = `${temp} ${UnitToUnicode(config.TemperatureUnit)}`;
            if (config._showBothTempUnits) {
                const secondUnit = "celsius" == config.TemperatureUnit ? "fahrenheit" : "celsius";
                let secondTemp = "celsius" == config.TemperatureUnit ? KelvinToFahrenheit(kelvin) : KelvinToCelsius(kelvin);
                secondTemp = RussianTransform(secondTemp, config._tempRussianStyle);
                if (withUnit) temp += ` (${secondTemp.toString()} ${UnitToUnicode(secondUnit)})`; else temp += ` (${secondTemp.toString()})`;
            }
            return temp.toString();
        }
        function RussianTransform(temp, russianStyle) {
            if (russianStyle) if (temp < 0) return `−${Math.abs(temp).toString()}`; else if (temp > 0) return `+${temp.toString()}`;
            return temp.toString();
        }
        function TempRangeToUserConfig(min, max, config) {
            ...
            let result = "";
            if (null != first_temperature) result = first_temperature;
            result += config._tempRussianStyle ? ELLIPSIS : ` ${FORWARD_SLASH} `;
            if (null != second_temperature) result += `${second_temperature} `;
        ...
        function PressToUserUnits(hpa, units) {
            switch (units) {
              case "hPa":
                return Math.round(100 * hpa) / 100;

              case "at":
                return Math.round(.001019716 * hpa * 1e3) / 1e3;

              case "atm":
                return Math.round(.0009869233 * hpa * 1e3) / 1e3;

              case "in Hg":
                return Math.round(.029529983071445 * hpa * 10) / 10;

              case "mm Hg":
                return Math.round(.7500638 * hpa);

              case "Pa":
                return Math.round(100 * hpa);

              case "psi":
                return Math.round(.01450377 * hpa * 100) / 100;
            }
        }
        function MetreToUserUnits(m, distanceUnit) {
            if ("metric" == distanceUnit) return Math.round(m / 1e3 * 10) / 10;
            return Math.round(10 * KmToM(m / 1e3)) / 10;
        }
        function MillimeterToUserUnits(mm, distanceUnit) {
            if ("metric" == distanceUnit) return Math.round(10 * mm) / 10;
            return Math.round(.03937 * mm * 100) / 100;
        }
        function KPHtoMPS(speed) {
            if (null == speed) return 0;
            return speed / WEATHER_CONV_KPH_IN_MPS;
        }
        function CelsiusToKelvin(celsius) {
            if (null == celsius) return null;
            return celsius + 273.15;
        }
        function FahrenheitToKelvin(fahrenheit) {
            if (null == fahrenheit) return null;
            return (fahrenheit - 32) / 1.8 + 273.15;
        }
        function MPHtoMPS(speed) {
            if (null == speed || void 0 == speed) return null;
            return .44704 * speed;
        }
        function KmToM(km) {
            return .6213712 * km;
        ...
        function CompassDirection(deg) {
            const directions = [ "south-arrow-weather-symbolic", "south-west-arrow-weather-symbolic", "west-arrow-weather-symbolic", "north-west-arrow-weather-symbolic", "north-arrow-weather-symbolic", "north-east-arrow-weather-symbolic", "east-arrow-weather-symbolic", "south-east-arrow-weather-symbolic" ];
        ...
        function IsCoordinate(text) {
            text = text.trim();
            if (/^-?\d{1,3}(?:\.\d*)?,(\s)*-?\d{1,3}(?:\.\d*)?/.test(text)) return true;
            return false;
        }
        function NotEmpty(str) {
            return null != str && str.length > 0 && void 0 != str;
        }
        ...
        function WeatherIconSafely(icons, icon_type) {
            for (const icon of icons) if (HasIcon(icon, icon_type)) return icon;
            return "weather-severe-alert";
        }
        function ShadeHexColor(color, percent) {
            var f = parseInt(color.slice(1), 16), t = percent < 0 ? 0 : 255, p = percent < 0 ? -1 * percent : percent, R = f >> 16, G = f >> 8 & 255, B = 255 & f;
        ...
        function utils_setTimeout(func, ms) {
            let args = [];
            if (arguments.length > 2) args = args.slice.call(arguments, 2);
        ...
        async function FileExists(file, dictionary = false) {
            try {
                ...
                if (e instanceof Error) logger_Logger.Error("Cannot get file info for '" + file.get_path() + "', error: ", e);
                return false;
            }
        }
        ...
        async function OverwriteAndGetIOStream(file) {
            ...
            if (null != parent && !FileExists(parent)) parent.make_directory_with_parents(null);
            return new Promise(((resolve, reject) => {
        ...
        class Log {
            ...
            Error(error, e) {
                ...
                if (!!(null === e || void 0 === e ? void 0 : e.stack)) global.logError(e.stack);
            }
            Debug(message) {
            ...
            async GetAppletLogs() {
                var _a, _b, _c;
                const home = null !== (_a = get_home_dir()) && void 0 !== _a ? _a : "~";
                let logFilePath = `${home}/`;
                if (-1 == CompareVersion(imports.misc.config.PACKAGE_VERSION, "3.8.8")) logFilePath += ".cinnamon/glass.log"; else {
                    const errFileEnv = get_environ().find((x => x.includes("ERRFILE")));
                    if (!errFileEnv) logFilePath += ".xsession-errors"; else logFilePath = errFileEnv.replace("ERRFILE=", "");
                }
                const logFile = File.new_for_path(logFilePath);
                if (!await FileExists(logFile)) throw new Error(_("Could not retrieve logs, log file was not found under path\n {logFilePath}", {
                    logFilePath
                }));
                const logs = await LoadContents(logFile);
                if (null == logs) throw new Error(_("Could not get contents of log file under path\n {logFilePath}", {
                    logFilePath
                }));
                const logLines = logs.split("\n");
                const filteredLines = [];
                let lastWasCinnamonLog = false;
                for (const line of logLines) if (lastWasCinnamonLog && (null !== (_c = null === (_b = line.match(/.js:\d+:\d+$/gm)) || void 0 === _b ? void 0 : _b.length) && void 0 !== _c ? _c : 0) > 0) filteredLines.push(line); else if (line.includes("LookingGlass") && line.includes(UUID)) {
                    filteredLines.push(line);
                    lastWasCinnamonLog = true;
                } else lastWasCinnamonLog = false;
        ...
        class Event {
            static DisconnectAll() {
                for (const event of this.eventStore) event.UnSubscribeAll();
            }
            constructor() {
                this.subscribers = [];
            ...
            Invoke(sender, args) {
                if (0 == this.subscribers.length) return;
                for (const element of this.subscribers) element(sender, args);
            }
            UnSubscribeAll() {
                this.subscribers = [];
            }
        ...
        class NotificationService {
            static get Instance() {
                if (null == this.instance) this.instance = new NotificationService;
        ...
        class LocationStore {
            ...
            OnLocationChanged(locs) {
                var _a;
                if (this.app.Locked()) return;
                for (let index = 0; index < locs.length; index++) {
                    const element = locs[index];
                    if (!element.entryText) locs[index] = this.EnsureSearchEntry(element);
                }
                ...
                if (-1 == newIndex && -1 == currentIndex) {
                    let tmp = [];
                    this.locations = locs.concat(tmp);
                    this.InvokeStorageChanged();
                    return;
                } else if (newIndex == currentIndex) currentlyDisplayedChanged = !this.IsEqual(null === (_a = this.locations) || void 0 === _a ? void 0 : _a[currentIndex], null === locs || void 0 === locs ? void 0 : locs[currentIndex]); else if (-1 == newIndex) currentlyDisplayedDeleted = true; else if (newIndex != currentIndex) this.currentIndex = newIndex;
                let tmp = [];
                this.locations = locs.concat(tmp);
            ...
            FindLocation(entryText) {
                for (const location of this.locations) if (location.entryText == entryText) return {
            ...
            NormalizeTZ(tz) {
                ...
                if (!valid) logger_Logger.Info(`Timezone '${tz}' is not valid for saved location, switching for local tz '${DateTime.local().zoneName}'`);
                return valid;
            }
            EnsureSearchEntry(loc) {
                if (!loc.entryText) loc.entryText = `${loc.lat},${loc.lon}`;
                return loc;
            }
            GetNextLocation(currentLoc) {
                if (null == currentLoc) return null;
                logger_Logger.Debug("Current location: " + JSON.stringify(currentLoc, null, 2));
                if (0 == this.locations.length) return currentLoc;
                let nextIndex = null;
                ...
                } else nextIndex = this.currentIndex++;
            ...
            GetPreviousLocation(currentLoc) {
                ...
                } else previousIndex = this.currentIndex--;
                if (previousIndex < 0) {
            ...
            ShouldShowLocationSelectors(currentLoc) {
                if (null == currentLoc) return false;
                const threshold = this.InStorage(currentLoc) ? 2 : 1;
                if (this.locations.length >= threshold) return true; else return false;
            }
            async SaveCurrentLocation(loc) {
                ...
                if (this.app.config.Timezone) loc.timeZone = this.app.config.Timezone;
            ...
            InStorage(loc) {
                return -1 != this.FindIndex(loc);
            }
            FindIndex(loc, locations = null) {
                if (null == loc) return -1;
                if (null == locations) locations = this.locations;
                for (const [index, element] of locations.entries()) if (element.entryText == loc.entryText) return index;
                return -1;
            }
            IsEqual(oldLoc, newLoc) {
                if (null == oldLoc) return false;
                if (null == newLoc) return false;
                let key;
                for (key in newLoc) if (oldLoc[key] != newLoc[key]) return false;
                return true;
            }
        }
        ...
        class GeoLocation {
            ...
            async GetLocation(searchText) {
                ...
                try {
                    ...
                    const cached = null === (_a = this.cache) || void 0 === _a ? void 0 : _a.searchText;
                    if (null != cached) {
                    ...
                    if (null == locationData) return null;
                    if (0 == locationData.length) {
                        this.App.ShowError({
                            type: "hard",
            ...
            BuildEntryText(locationData) {
                if (null == locationData.address) return locationData.display_name;
                const entryText = [];
                for (const key in locationData.address) {
                    if ("state_district" == key) continue;
                    if ("county" == key) continue;
                    if ("country_code" == key) continue;
        ...
        class MetUk extends BaseProvider {
            constructor(_app) {
                ...
                this.MAX_STATION_DIST = 5e4;
                this.ParseForecast = (json, loc) => {
                    var _a, _b, _c, _d, _e;
                    const forecasts = [];
                    try {
                        const period = null !== (_c = null === (_b = null === (_a = json.SiteRep.DV) || void 0 === _a ? void 0 : _a.Location) || void 0 === _b ? void 0 : _b.Period) && void 0 !== _c ? _c : [];
                        for (const element of Array.isArray(period) ? period : [ period ]) {
                            if (!Array.isArray(element.Rep)) continue;
                            const day = element.Rep[0];
                            const night = element.Rep[1];
                            const forecast = {
                                date: DateTime.fromISO(this.PartialToISOString(element.value), {
                                    zone: loc.timeZone
                                }),
                                temp_min: CelsiusToKelvin(parseFloat(null !== (_d = night.Nm) && void 0 !== _d ? _d : "0")),
                                temp_max: CelsiusToKelvin(parseFloat(null !== (_e = day.Dm) && void 0 !== _e ? _e : "0")),
                        ...
                        if (e instanceof Error) logger_Logger.Error("MET UK Forecast Parsing error: " + e, e);
                        this.app.ShowError({
                            type: "soft",
                ...
                this.ParseHourlyForecast = (json, loc) => {
                    ...
                    try {
                        for (const day of Array.isArray(json.SiteRep.DV.Location.Period) ? json.SiteRep.DV.Location.Period : [ json.SiteRep.DV.Location.Period ]) {
                            const date = DateTime.fromISO(this.PartialToISOString(day.value), {
                                zone: loc.timeZone
                            });
                            if (!Array.isArray(day.Rep)) continue;
                            for (const element of day.Rep) {
                                const hour = element;
                                const timestamp = date.plus({
                                    hours: parseInt(hour.$) / 60
                                });
                                const threshold = DateTime.utc().setZone(loc.timeZone).minus({
                                    hours: 3
                                });
            ...
            async GetWeather(newLoc) {
                ...
                if (null == this.currentLocID || this.currentLocID != loc || null == this.forecastSite || null == this.observationSites || 0 == this.observationSites.length) {
                    ...
                    if (null == forecastSite) return null;
                    const observationSites = await this.GetObservationSitesInRange(newLoc, this.MAX_STATION_DIST);
                    if (null == observationSites) return null;
                    this.forecastSite = forecastSite;
                    this.observationSites = observationSites;
                } else logger_Logger.Debug("Site data downloading skipped");
                if (0 == this.observationSites.length || this.forecastSite.dist > 1e5) {
            ...
            async GetClosestForecastSite(loc) {
                ...
                if (null == forecastSitelist) return null;
            ...
            async GetObservationSitesInRange(loc, range) {
                ...
                if (null == observationSiteList) return null;
                ...
                for (const element of observationSiteList.Locations.Location) {
                    ...
                    if (element.dist > range) continue;
            ...
            async GetObservationData(observationSites) {
                ...
                for (const element of observationSites) {
                    ...
                    if (!!payload) observations.push(payload); else logger_Logger.Debug("Failed to get observations from " + element.id);
                }
                return observations;
            }
            ...
            ParseCurrent(json, loc) {
                ...
                for (const [index, element] of json.entries()) {
                    if (null == element.SiteRep.DV.Location) continue;
                    dataIndex = index;
                    break;
                }
                ...
                try {
                    const weather = {
                        ...
                        date: DateTime.fromISO(json[dataIndex].SiteRep.DV.dataDate, {
                            zone: loc.timeZone
                        }),
                        ...
                        humidity: null,
                        dewPoint: null,
                        condition: this.ResolveCondition(null === observation || void 0 === observation ? void 0 : observation.W),
                        forecasts: []
                    };
                    if (null != (null === observation || void 0 === observation ? void 0 : observation.V)) weather.extra_field = {
                        name: _("Visibility"),
                        value: this.VisibilityToText(observation.V),
                        type: "string"
                    };
                    if (null != (null === observation || void 0 === observation ? void 0 : observation.S)) weather.wind.speed = MPHtoMPS(parseFloat(observation.S));
                    if (null != (null === observation || void 0 === observation ? void 0 : observation.D)) weather.wind.degree = CompassToDeg(observation.D);
                    if (null != (null === observation || void 0 === observation ? void 0 : observation.T)) weather.temperature = CelsiusToKelvin(parseFloat(observation.T));
                    if (null != (null === observation || void 0 === observation ? void 0 : observation.P)) weather.pressure = parseFloat(observation.P);
                    if (null != (null === observation || void 0 === observation ? void 0 : observation.H)) weather.humidity = parseFloat(observation.H);
                    if (null != (null === observation || void 0 === observation ? void 0 : observation.Dp)) weather.dewPoint = CelsiusToKelvin(parseFloat(observation.Dp));
                    return weather;
                } catch (e) {
                    if (e instanceof Error) logger_Logger.Error("Met UK Weather Parsing error: " + e, e);
                    this.app.ShowError({
                        type: "soft",
                        service: "Met Office UK",
                        detail: "unusual payload",
            ...
            VisibilityToText(dist) {
                ...
                if (distance < 1e3) {
                    stringFormat.distance = MetreToUserUnits(1e3, unit).toString();
                    return `${_("Very poor")} - ${_("Less than {distance} {distanceUnit}", stringFormat)}`;
                } else if (distance >= 4e4) {
                    stringFormat.distance = MetreToUserUnits(4e4, unit).toString();
                    return `${_("Excellent")} - ${_("More than {distance} {distanceUnit}", stringFormat)}`;
                } else if (distance < 4e3) {
                    stringFormat.smallerDistance = MetreToUserUnits(1e3, unit).toString();
                    stringFormat.biggerDistance = MetreToUserUnits(4e3, unit).toString();
                    return `${_("Poor")} - ${_("Between {smallerDistance}-{biggerDistance} {distanceUnit}", stringFormat)}`;
                } else if (distance < 1e4) {
                    stringFormat.smallerDistance = MetreToUserUnits(4e3, unit).toString();
                    stringFormat.biggerDistance = MetreToUserUnits(1e4, unit).toString();
                    return `${_("Moderate")} - ${_("Between {smallerDistance}-{biggerDistance} {distanceUnit}", stringFormat)}`;
                } else if (distance < 2e4) {
                    stringFormat.smallerDistance = MetreToUserUnits(1e4, unit).toString();
                    stringFormat.biggerDistance = MetreToUserUnits(2e4, unit).toString();
                    return `${_("Good")} - ${_("Between {smallerDistance}-{biggerDistance} {distanceUnit}", stringFormat)}`;
                } else if (distance < 4e4) {
                    stringFormat.smallerDistance = MetreToUserUnits(2e4, unit).toString();
                    stringFormat.biggerDistance = MetreToUserUnits(4e4, unit).toString();
            ...
            MeshObservations(observations, loc) {
                ...
                if (0 == observations.length) return null;
                const firstPeriod = null !== (_e = null === (_d = null === (_c = null === (_b = null === (_a = observations[0]) || void 0 === _a ? void 0 : _a.SiteRep) || void 0 === _b ? void 0 : _b.DV) || void 0 === _c ? void 0 : _c.Location) || void 0 === _d ? void 0 : _d.Period) && void 0 !== _e ? _e : [];
                ...
                if (1 == observations.length) return result;
                for (const [index, observation] of observations.entries()) {
                    if (null == (null === (_h = null === (_g = null === (_f = null === observation || void 0 === observation ? void 0 : observation.SiteRep) || void 0 === _f ? void 0 : _f.DV) || void 0 === _g ? void 0 : _g.Location) || void 0 === _h ? void 0 : _h.Period)) continue;
                    if (!Array.isArray(observation.SiteRep.DV.Location.Period)) observation.SiteRep.DV.Location.Period = [ observation.SiteRep.DV.Location.Period ];
                    ...
                    if (null == result) result = nextObservation;
                    const debugText = " Observation data missing, plugged in from ID " + observation.SiteRep.DV.Location.i + ", index " + index + ", distance " + Math.round(GetDistance(parseFloat(observation.SiteRep.DV.Location.lat), parseFloat(observation.SiteRep.DV.Location.lon), this.currentLoc.lat, this.currentLoc.lon)) + " metres";
                    if (null != result) {
                        if (null == (null === result || void 0 === result ? void 0 : result.V)) {
                            result.V = null === nextObservation || void 0 === nextObservation ? void 0 : nextObservation.V;
                            logger_Logger.Debug("Visibility" + debugText);
                        }
                        if (null == (null === result || void 0 === result ? void 0 : result.W)) {
                            result.W = null === nextObservation || void 0 === nextObservation ? void 0 : nextObservation.W;
                            logger_Logger.Debug("Weather condition" + debugText);
                        }
                        if (null == (null === result || void 0 === result ? void 0 : result.S)) {
                            result.S = null === nextObservation || void 0 === nextObservation ? void 0 : nextObservation.S;
                            logger_Logger.Debug("Wind Speed" + debugText);
                        }
                        if (null == (null === result || void 0 === result ? void 0 : result.D)) {
                            result.D = null === nextObservation || void 0 === nextObservation ? void 0 : nextObservation.D;
                            logger_Logger.Debug("Wind degree" + debugText);
                        }
                        if (null == (null === result || void 0 === result ? void 0 : result.T)) {
                            result.T = null === nextObservation || void 0 === nextObservation ? void 0 : nextObservation.T;
                            logger_Logger.Debug("Temperature" + debugText);
                        }
                        if (null == (null === result || void 0 === result ? void 0 : result.P)) {
                            result.P = null === nextObservation || void 0 === nextObservation ? void 0 : nextObservation.P;
                            logger_Logger.Debug("Pressure" + debugText);
                        }
                        if (null == (null === result || void 0 === result ? void 0 : result.H)) {
                            result.H = null === nextObservation || void 0 === nextObservation ? void 0 : nextObservation.H;
                            logger_Logger.Debug("Humidity" + debugText);
                        }
                        if (null == (null === result || void 0 === result ? void 0 : result.Dp)) {
                            result.Dp = null === nextObservation || void 0 === nextObservation ? void 0 : nextObservation.Dp;
            ...
            GetLatestObservation(observations, day, loc) {
                if (null == observations) return null;
                for (const element of observations) {
                    const date = DateTime.fromISO(this.PartialToISOString(element.value), {
                        zone: loc.timeZone
                    });
                    if (!OnSameDay(date, day)) continue;
                    if (Array.isArray(element.Rep)) return element.Rep[element.Rep.length - 1]; else return element.Rep;
                }
                return null;
            }
            ...
            GetClosestSite(siteList, loc) {
                ...
                for (const element of sites) {
                    element.dist = GetDistance(parseFloat(element.latitude), parseFloat(element.longitude), loc.lat, loc.lon);
                    if (element.dist < closest.dist) closest = element;
                }
                return closest;
            }
        ...
        class OpenWeatherMap extends BaseProvider {
            constructor(_app) {
                ...
                this.supportedLanguages = [ "af", "al", "ar", "az", "bg", "ca", "cz", "da", "de", "el", "en", "eu", "fa", "fi", "fr", "gl", "he", "hi", "hr", "hu", "id", "it", "ja", "kr", "la", "lt", "mk", "no", "nl", "pl", "pt", "pt_br", "ro", "ru", "se", "sk", "sl", "sp", "es", "sr", "th", "tr", "ua", "uk", "vi", "zh_cn", "zh_tw", "zu" ];
                this.base_url = "https://api.openweathermap.org/data/2.5/onecall";
                this.id_irl = "https://api.openweathermap.org/data/2.5/weather";
                this.HandleError = error => {
                    if (404 == error.ErrorData.code) {
                        this.app.ShowError({
            ...
            async GetWeather(loc) {
                ...
                const [json, idPayload] = await Promise.all([ this.app.LoadJsonAsync(this.base_url, params, this.HandleError), null == cachedID ? this.app.LoadJsonAsync(this.id_irl, params) : Promise.resolve() ]);
                if (null == cachedID && null != (null === idPayload || void 0 === idPayload ? void 0 : idPayload.id)) IDCache[`${loc.lat},${loc.lon}`] = idPayload.id;
                if (!json) return null;
                if (this.HadErrors(json)) return null;
                json.id = null !== cachedID && void 0 !== cachedID ? cachedID : null === idPayload || void 0 === idPayload ? void 0 : idPayload.id;
            ...
            ParseWeather(json, loc) {
                ...
                try {
                    const weather = {
                        ...
                        location: {
                            url: null == json.id ? "https://openweathermap.org/city/" : `https://openweathermap.org/city/${json.id}`,
                        ...
                        condition: {
                            main: null === (_c = null === (_b = null === (_a = null === json || void 0 === json ? void 0 : json.current) || void 0 === _a ? void 0 : _a.weather) || void 0 === _b ? void 0 : _b[0]) || void 0 === _c ? void 0 : _c.main,
                            description: null === (_f = null === (_e = null === (_d = null === json || void 0 === json ? void 0 : json.current) || void 0 === _d ? void 0 : _d.weather) || void 0 === _e ? void 0 : _e[0]) || void 0 === _f ? void 0 : _f.description,
                            icons: this.ResolveIcon(null === (_j = null === (_h = null === (_g = null === json || void 0 === json ? void 0 : json.current) || void 0 === _g ? void 0 : _g.weather) || void 0 === _h ? void 0 : _h[0]) || void 0 === _j ? void 0 : _j.icon),
                            customIcon: this.ResolveCustomIcon(null === (_m = null === (_l = null === (_k = null === json || void 0 === json ? void 0 : json.current) || void 0 === _k ? void 0 : _k.weather) || void 0 === _l ? void 0 : _l[0]) || void 0 === _m ? void 0 : _m.icon)
                        },
                        extra_field: {
                            name: _("Feels Like"),
                    ...
                    if (null != json.minutely) {
                        const immediate = {
                            start: -1,
                            end: -1
                        };
                        for (const [index, element] of json.minutely.entries()) if (element.precipitation > 0 && -1 == immediate.start) {
                            immediate.start = index;
                            continue;
                        } else if (0 == element.precipitation && -1 != immediate.start) {
                            immediate.end = index;
                            break;
                        }
                    ...
                    for (const hour of json.hourly) {
                        ...
                        if (hour.pop >= .1) forecast.precipitation = {
                            chance: 100 * hour.pop,
                            type: "none"
                        };
                        if (!!hour.rain && null != forecast.precipitation) {
                            forecast.precipitation.volume = null === hour || void 0 === hour ? void 0 : hour.rain["1h"];
                            forecast.precipitation.type = "rain";
                        }
                        if (!!hour.snow && null != forecast.precipitation) {
                    ...
                    if (e instanceof Error) logger_Logger.Error("OpenWeatherMap Weather Parsing error: " + e, e);
                    this.app.ShowError({
                        type: "soft",
            ...
            ConstructParams(loc) {
                ...
                if (this.app.config._translateCondition && IsLangSupported(locale, this.supportedLanguages)) params.lang = locale;
                return params;
            }
            ConvertToAPILocale(systemLocale) {
                if (null == systemLocale) return "en";
                if ("zh-cn" == systemLocale || "zh-cn" == systemLocale || "pt-br" == systemLocale) return systemLocale;
                const lang = systemLocale.split("-")[0];
                if ("sv" == lang) return "se"; else if ("cs" == lang) return "cz"; else if ("ko" == lang) return "kr"; else if ("lv" == lang) return "la"; else if ("nn" == lang || "nb" == lang) return "no";
                return lang;
            }
            HadErrors(json) {
            ...
            HasReturnedError(json) {
                return !!(null === json || void 0 === json ? void 0 : json.cod);
            }
            ResolveIcon(icon) {
                switch (icon) {
                  case "10d":
        ...
        _("Thunderstorm with light rain"), _("Thunderstorm with rain"), _("Thunderstorm with heavy rain"), 
        _("Light thunderstorm"), _("Thunderstorm"), _("Heavy thunderstorm"), _("Ragged thunderstorm"), 
        _("Thunderstorm with light drizzle"), _("Thunderstorm with drizzle"), _("Thunderstorm with heavy drizzle"), 
        _("Light intensity drizzle"), _("Drizzle"), _("Heavy intensity drizzle"), _("Light intensity drizzle rain"), 
        _("Drizzle rain"), _("Heavy intensity drizzle rain"), _("Shower rain and drizzle"), 
        _("Heavy shower rain and drizzle"), _("Shower drizzle"), _("Light rain"), _("Moderate rain"), 
        _("Heavy intensity rain"), _("Very heavy rain"), _("Extreme rain"), _("Freezing rain"), 
        _("Light intensity shower rain"), _("Shower rain"), _("Heavy intensity shower rain"), 
        _("Ragged shower rain"), _("Light snow"), _("Snow"), _("Heavy snow"), _("Sleet"), 
        _("Shower sleet"), _("Light rain and snow"), _("Rain and snow"), _("Light shower snow"), 
        _("Shower snow"), _("Heavy shower snow"), _("Mist"), _("Smoke"), _("Haze"), _("Sand, dust whirls"), 
        _("Fog"), _("Sand"), _("Dust"), _("Volcanic ash"), _("Squalls"), _("Tornado"), _("Clear"), 
        _("Clear sky"), _("Sky is clear"), _("Clouds"), _("Few clouds"), _("Scattered clouds"), 
        _("Broken clouds"), _("Overcast clouds");
        ...
        function IsCovered(payload) {
            return "ok" == payload.properties.meta.radar_coverage;
        }
        ...
        class MetNorway extends BaseProvider {
            ...
            async GetWeather(loc) {
                const [forecast, nowcast] = await Promise.all([ this.app.LoadJsonAsync(`${this.baseUrl}/locationforecast/2.0/complete`, {
                    lat: loc.lat,
                    lon: loc.lon
                }), this.app.LoadJsonAsync(`${this.baseUrl}/nowcast/2.0/complete`, {
                    lat: loc.lat,
                    lon: loc.lon
                }, (e => 422 != e.ErrorData.code)) ]);
                if (!forecast) {
                ...
                if (null != nowcast) {
                    result.date = DateTime.fromISO(nowcast.properties.meta.updated_at, {
                        zone: loc.timeZone
                    });
                    ...
                    if (IsCovered(nowcast)) if (nowcast.properties.timeseries[0].data.next_1_hours.details.precipitation_amount > 0) {
                        const immediate = {
                            start: -1,
                            end: -1
                        };
                        for (let i = 0; i < nowcast.properties.timeseries.length; i++) {
                            ...
                            if (null != next && DateTime.fromISO(next.time).diffNow().milliseconds < 0) continue;
                            if (element.data.instant.details.precipitation_rate > 0 && -1 == immediate.start) {
                                immediate.start = DateTime.fromISO(element.time).diffNow().minutes;
                                continue;
                            } else if (0 == element.data.instant.details.precipitation_rate && -1 != immediate.start) {
            ...
            RemoveEarlierElements(json, loc) {
                ...
                for (const [i, element] of json.properties.timeseries.entries()) {
                    const timestamp = DateTime.fromISO(element.time, {
                        zone: loc.timeZone
                    });
                    if (timestamp < now && now.hour != timestamp.hour) startIndex = i; else break;
                }
                if (-1 != startIndex) {
            ...
            ParseWeather(json, loc) {
                ...
                const result = {
                    ...
                    date: DateTime.fromISO(current.time, {
                        zone: loc.timeZone
                    }),
                    condition: this.ResolveCondition(null === (_b = null === (_a = current.data.next_1_hours) || void 0 === _a ? void 0 : _a.summary) || void 0 === _b ? void 0 : _b.symbol_code, IsNight(suntimes)),
                ...
                for (const element of json.properties.timeseries) if (!!element.data.next_1_hours) hourlyForecasts.push({
                    date: DateTime.fromISO(element.time, {
                        zone: loc.timeZone
                    }),
                    ...
                    condition: this.ResolveCondition(element.data.next_1_hours.summary.symbol_code, IsNight(suntimes, DateTime.fromISO(element.time, {
                        zone: loc.timeZone
                    })))
                });
            ...
            BuildForecasts(forecastsData, loc) {
                ...
                for (const day of days) {
                    ...
                    for (const element of day) {
                        ...
                        forecast.date = DateTime.fromISO(element.time, {
                            zone: loc.timeZone
                        });
                        ...
                        if (!conditionCounter[severity]) conditionCounter[severity] = {
                            count: 0,
                            name: symbol
                        };
            ...
            GetEarliestDataForToday(events, loc) {
                ...
                for (const [i, element] of events.entries()) {
                    const earliestElementTime = DateTime.fromISO(element.time, {
                        zone: loc.timeZone
                    });
                    const timestamp = DateTime.fromISO(element.time, {
                        zone: loc.timeZone
            ...
            SortDataByDay(data, loc) {
                const days = [];
                let currentDay = DateTime.fromISO(this.GetEarliestDataForToday(data, loc).time, {
                    zone: loc.timeZone
                });
                let dayIndex = 0;
                days.push([]);
                for (const element of data) {
                    ...
                    if (OnSameDay(timestamp, currentDay)) days[dayIndex].push(element); else if (!OnSameDay(timestamp, currentDay)) {
                        dayIndex++;
            ...
            GetMostCommonCondition(count) {
                let result = null;
                for (const key in count) if (null == result || count[result].count < count[key].count) result = parseInt(key);
            ...
            GetMostSevereCondition(conditions) {
                ...
                for (const key in conditions) {
                    ...
                    const resultStripped = null == result ? -1 : result > 100 ? result - 100 : result;
                ...
                if (null == result) return null;
                if (result <= 4) return this.GetMostCommonCondition(conditions);
        ...
        class Weatherbit extends BaseProvider {
            ...
            constructor(_app) {
                ...
                this.supportHourlyPrecipChance = true;
                this.supportHourlyPrecipVolume = true;
                this.supportedLanguages = [ "ar", "az", "be", "bg", "bs", "ca", "cz", "da", "de", "el", "en", "et", "fi", "fr", "hr", "hu", "id", "is", "it", "kw", "lv", "nb", "nl", "pl", "pt", "ro", "ru", "sk", "sl", "sr", "sv", "tr", "uk", "zh", "zh-tw" ];
                ...
                this.ParseCurrent = json => {
                    json = json.data[0];
                    const hourDiff = this.HourDifference(DateTime.fromSeconds(json.ts, {
                        zone: json.timezone
                    }), this.ParseStringTime(json.ob_time, json.timezone));
                    if (0 != hourDiff) logger_Logger.Debug("Weatherbit reporting incorrect time, correcting with " + (0 - hourDiff).toString() + " hours");
                    try {
                        const weather = {
                            coord: {
                                lat: json.lat,
                        ...
                        if (e instanceof Error) logger_Logger.Error("Weatherbit Weather Parsing error: " + e, e);
                        this.app.ShowError({
                            type: "soft",
                            service: "Weatherbit",
                            detail: "unusual payload",
                ...
                this.ParseForecast = json => {
                    ...
                    try {
                        ...
                        if (e instanceof Error) logger_Logger.Error("Weatherbit Forecast Parsing error: " + e, e);
                        this.app.ShowError({
                            type: "soft",
                            service: "Weatherbit",
                            detail: "unusual payload",
                ...
                this.ParseHourlyForecast = json => {
                    ...
                    try {
                        for (const hour of json.data.length) {
                            ...
                            if (!!forecast.precipitation && 0 != hour.snow) {
                                forecast.precipitation.type = "snow";
            ...
            async GetData(baseUrl, loc, ParseFunction) {
                ...
                if (null == query) return null;
                const json = await this.app.LoadJsonAsync(query, void 0, (e => this.HandleError(e)));
                if (null == json) return null;
            ...
            async GetHourlyData(baseUrl, loc) {
                const query = this.ConstructQuery(baseUrl, loc);
                if (null == query) return null;
                const json = await this.app.LoadJsonAsync(query, void 0, (e => this.HandleHourlyError(e)));
                if (!!(null === json || void 0 === json ? void 0 : json.error)) return null;
                if (null == json) return null;
            ...
            HourDifference(correctTime, incorrectTime) {
                if (null == incorrectTime) return 0;
                return Math.round((incorrectTime.hour - correctTime.hour) / (1e3 * 60 * 60));
            }
            ParseStringTime(last_ob_time, tz) {
                const split = last_ob_time.split(/[T\-\s:]/);
                if (5 != split.length) return null;
            ...
            ConvertToAPILocale(systemLocale) {
                ...
                if ("zh-tw" == systemLocale) return systemLocale;
                const lang = systemLocale.split("-")[0];
                if ("cs" == lang) return "cz";
                return lang;
            }
            ConstructQuery(query, loc) {
                ...
                if (IsLangSupported(lang, this.supportedLanguages) && this.app.config._translateCondition) query = query + "&lang=" + lang;
                return query;
            }
            HandleError(message) {
                if (403 == message.ErrorData.code) this.app.ShowError({
                    type: "hard",
                    userError: true,
                    detail: "bad key",
                    service: "Weatherbit",
        ...
        class ClimacellV4 extends BaseProvider {
            ...
            ParseWeather(loc, data) {
                var _a, _b, _c, _d, _e;
                const current = null === (_b = null === (_a = data.data.timelines.find((x => "current" == x.timestep))) || void 0 === _a ? void 0 : _a.intervals) || void 0 === _b ? void 0 : _b[0];
                const hourly = null === (_c = data.data.timelines.find((x => "1h" == x.timestep))) || void 0 === _c ? void 0 : _c.intervals;
                const daily = null === (_d = data.data.timelines.find((x => "1d" == x.timestep))) || void 0 === _d ? void 0 : _d.intervals;
                if (!current || !daily || !hourly || !(null === (_e = daily[0]) || void 0 === _e ? void 0 : _e.values)) return null;
                const sunrise = DateTime.fromISO(daily[0].values.sunriseTime, {
                    zone: loc.timeZone
                });
                const sunset = DateTime.fromISO(daily[0].values.sunsetTime, {
                    zone: loc.timeZone
                });
                ...
                const result = {
                    ...
                    date: DateTime.fromISO(current.startTime, {
                        zone: loc.timeZone
                    }),
                    condition: this.ResolveCondition(current.values.weatherCode, IsNight({
                        sunrise,
                        sunset
                    }, now)),
                ...
                for (const element of daily) {
                    const date = DateTime.fromISO(element.startTime, {
                        zone: loc.timeZone
                    });
                    days.push({
                        condition: this.ResolveCondition(element.values.weatherCode, IsNight({
                            sunrise,
                            sunset
                        }, date)),
                        date,
                ...
                for (const element of hourly) {
                    let date = DateTime.fromISO(element.startTime, {
                        zone: loc.timeZone
                    });
                    date = date.set({
                        minute: 0,
                    ...
                    if (element.values.precipitationProbability > 0 && element.values.precipitationIntensity > 0) hour.precipitation = {
        ...
        class USWeather extends BaseProvider {
            constructor(_app) {
                ...
                this.OnObtainingGridData = message => {
                    if (404 == message.ErrorData.code && null != (null === message || void 0 === message ? void 0 : message.Data)) {
                        if ("Data Unavailable For Requested Point" == message.Data.title) this.app.ShowError({
                            type: "hard",
                            userError: true,
                            detail: "location not covered",
                            service: "US Weather",
                ...
                this.ParseForecast = json => {
                    ...
                    try {
                        ...
                        if (false == json.properties.periods[startIndex].isDaytime) {
                            startIndex++;
                        ...
                        if (e instanceof Error) logger_Logger.Error("US Weather Forecast Parsing error: " + e, e);
                        this.app.ShowError({
                            type: "soft",
                            service: "US Weather",
                            detail: "unusual payload",
                ...
                this.ParseHourlyForecast = json => {
                    ...
                    try {
                        ...
                        if (e instanceof Error) logger_Logger.Error("US Weather service Forecast Parsing error: " + e, e);
                        this.app.ShowError({
                            type: "soft",
                            service: "US Weather",
                            detail: "unusual payload",
                            message: _("Failed to Process Hourly Forecast Info")
                        });
                        return null;
                    }
                };
            ...
            async GetWeather(loc) {
                ...
                if (!this.grid || !this.observationStations || this.currentLocID != locID) {
                    ...
                    if (null == observationStations) return null;
                    this.grid = grid;
                ...
                if (!!weather) {
                    weather.forecasts = null !== (_a = this.ParseForecast(forecast)) && void 0 !== _a ? _a : [];
                    weather.hourlyForecasts = null !== (_b = this.ParseHourlyForecast(hourly)) && void 0 !== _b ? _b : void 0;
                }
                return weather;
            }
            ...
            async GetStationData(stationListUrl) {
                ...
                return null === stations || void 0 === stations ? void 0 : stations.features;
            }
            async GetObservationsInRange(range, loc, stations) {
                ...
                for (const element of stations) {
                    ...
                    if (null == observation) logger_Logger.Debug("Failed to get observations from " + element.id); else observations.push(observation);
                }
                return observations;
            }
            ...
            ParseCurrent(json, hourly, loc) {
                ...
                if (null == observation || !this.observationStations[0]) {
                    logger_Logger.Error("No observation stations/data are available");
                    return null;
                }
                const timestamp = DateTime.fromISO(observation.properties.timestamp, {
                    zone: this.observationStations[0].properties.timeZone
                });
                ...
                try {
                    const weather = {
                        coord: {
                            lat: null === (_a = null === observation || void 0 === observation ? void 0 : observation.geometry) || void 0 === _a ? void 0 : _a.coordinates[1],
                            lon: null === (_b = null === observation || void 0 === observation ? void 0 : observation.geometry) || void 0 === _b ? void 0 : _b.coordinates[0]
                        },
                        location: {
                            city: void 0,
                            country: void 0,
                        ...
                        pressure: null == observation.properties.barometricPressure.value ? null : observation.properties.barometricPressure.value / 100,
                    ...
                    if (null != observation.properties.windChill.value) weather.extra_field = {
                        name: _("Feels Like"),
                        value: CelsiusToKelvin(observation.properties.windChill.value),
                        type: "temperature"
                    };
                    if (null == weather.condition && null != hourly) weather.condition = this.ResolveCondition(hourly.properties.periods[0].icon);
                    return weather;
                } catch (e) {
                    if (e instanceof Error) logger_Logger.Error("US Weather Parsing error: " + e, e);
                    this.app.ShowError({
                        type: "soft",
                        service: "US Weather",
                        detail: "unusual payload",
            ...
            CheckIfHasThreeElementsForDay(json) {
                var _a, _b, _c;
                if ((null === (_b = null === (_a = null === json || void 0 === json ? void 0 : json.properties) || void 0 === _a ? void 0 : _a.periods) || void 0 === _b ? void 0 : _b.length) < 3 || (null === (_c = this.observationStations[0]) || void 0 === _c ? void 0 : _c.properties)) return false;
                let counter = 0;
                for (let index = 1; index < 3; index++) {
                    ...
                    if (OnSameDay(prevDate, curDate)) counter++; else counter = 0;
            ...
            FindTodayIndex(json, startIndex = 0) {
                var _a;
                if (!this.observationStations[0] || !(null === (_a = null === json || void 0 === json ? void 0 : json.properties) || void 0 === _a ? void 0 : _a.periods)) return -1;
                ...
                for (let index = startIndex; index < json.properties.periods.length; index++) {
                    const element = json.properties.periods[index];
                    const curDate = DateTime.fromISO(element.startTime).setZone(this.observationStations[0].properties.timeZone);
                    if (!OnSameDay(today, curDate)) continue;
                    return index;
                }
                return -1;
            }
            ResolveCondition(icon, isNight = false) {
                ...
                switch (null === code || void 0 === code ? void 0 : code[0]) {
                  case "skc":
                    return {
                        main: _("Clear"),
                        description: _("Clear"),
        ...
        class VisualCrossing extends BaseProvider {
            ...
            ParseWeather(weather, translate) {
                ...
                const result = {
                    ...
                    humidity: null !== (_a = weather.currentConditions.humidity) && void 0 !== _a ? _a : null === currentHour || void 0 === currentHour ? void 0 : currentHour.humidity,
                    pressure: null !== (_b = weather.currentConditions.pressure) && void 0 !== _b ? _b : null === currentHour || void 0 === currentHour ? void 0 : currentHour.pressure,
                    dewPoint: CelsiusToKelvin(null !== (_c = weather.currentConditions.dew) && void 0 !== _c ? _c : null === currentHour || void 0 === currentHour ? void 0 : currentHour.dew),
                    wind: {
                        degree: null !== (_d = weather.currentConditions.winddir) && void 0 !== _d ? _d : null === currentHour || void 0 === currentHour ? void 0 : currentHour.winddir,
                        speed: null !== (_e = weather.currentConditions.windspeed) && void 0 !== _e ? _e : null === currentHour || void 0 === currentHour ? void 0 : currentHour.windspeed
                    },
                    temperature: CelsiusToKelvin(null !== (_f = weather.currentConditions.temp) && void 0 !== _f ? _f : null === currentHour || void 0 === currentHour ? void 0 : currentHour.temp),
                    ...
                    extra_field: {
                        name: _("Feels Like"),
                        type: "temperature",
                        value: CelsiusToKelvin(null !== (_g = null === currentHour || void 0 === currentHour ? void 0 : currentHour.feelslike) && void 0 !== _g ? _g : weather.currentConditions.feelslike)
                    },
            ...
            ParseForecasts(forecasts, translate, tz) {
                const result = [];
                if (!!forecasts) for (const element of forecasts) result.push({
            ...
            ParseHourlyForecasts(forecasts, translate, tz) {
                const currentHour = DateTime.utc().setZone(tz).set({
                    minute: 0,
                    second: 0,
                    millisecond: 0
                });
                const result = [];
                if (!!forecasts) for (const element of forecasts) {
                    if (!element.hours) continue;
                    for (const hour of element.hours) {
                        const time = DateTime.fromSeconds(hour.datetimeEpoch, {
                            zone: tz
                        });
                        ...
                        if (null != hour.preciptype) item.precipitation = {
            ...
            GetCurrentHour(forecasts, tz) {
                if (!forecasts || (null === forecasts || void 0 === forecasts ? void 0 : forecasts.length) < 1 || !forecasts[0].hours) return null;
                const currentHour = DateTime.utc().setZone(tz).set({
                    minute: 0,
                    second: 0,
                    millisecond: 0
            ...
            ResolveTypeIDs(condition) {
                ...
                for (const [index, element] of split.entries()) {
                    ...
                    if (index < split.length - 1) result += ", ";
                }
                return result;
            }
            HandleHttpError(error) {
                if (401 == (null === error || void 0 === error ? void 0 : error.ErrorData.code)) {
                    this.app.ShowError({
                        type: "hard",
                        userError: true,
                        detail: "bad key",
        ...
        class DanishMI extends BaseProvider {
            ...
            ParseWeather(observations, forecasts, loc) {
                ...
                const result = {
                    temperature: CelsiusToKelvin(null !== (_a = observation.Temperature2m) && void 0 !== _a ? _a : null),
                ...
                result.humidity = null !== (_b = result.humidity) && void 0 !== _b ? _b : forecasts.timeserie[0].humidity;
                result.pressure = null !== (_c = result.pressure) && void 0 !== _c ? _c : forecasts.timeserie[0].pressure;
                result.temperature = null !== (_d = result.temperature) && void 0 !== _d ? _d : CelsiusToKelvin(forecasts.timeserie[0].temp);
                result.wind.degree = null !== (_e = result.wind.degree) && void 0 !== _e ? _e : forecasts.timeserie[0].windDegree;
                result.wind.speed = null !== (_f = result.wind.speed) && void 0 !== _f ? _f : forecasts.timeserie[0].windSpeed;
                ...
                if ("alien-symbolic" == result.condition.customIcon) result.condition = this.ResolveCondition(forecasts.timeserie[0].symbol);
                const forecastData = [];
                for (let index = 0; index < forecasts.aggData.length - 1; index++) {
                    const element = forecasts.aggData[index];
                    forecastData.push({
                        date: DateTime.fromJSDate(this.DateStringToDate(element.time)).setZone(loc.timeZone, {
                            keepLocalTime: true
                        }),
                        temp_max: CelsiusToKelvin(element.maxTemp),
                        temp_min: CelsiusToKelvin(element.minTemp),
                        condition: this.ResolveDailyCondition(forecasts.timeserie, DateTime.fromJSDate(this.DateStringToDate(element.time)).setZone(loc.timeZone, {
                            keepLocalTime: true
                        }))
                    });
                }
                ...
                for (const element of forecasts.timeserie) {
                    ...
                    if (element.precip1 > .05 && null != element.precipType) hour.precipitation = {
            ...
            MergeObservations(observations) {
                ...
                const result = {
                    symbol: void 0,
                    PressureMSL: void 0,
                    Temperature2m: void 0,
                    WindDirection: void 0,
                    RelativeHumidity: void 0,
                    WindSpeed10m: void 0,
                    PrecAmount10Min: void 0,
                    WindGustLast10Min: void 0
                };
                for (const element of observations) {
                    result.symbol = null !== (_a = result.symbol) && void 0 !== _a ? _a : element.values.symbol;
                    result.PressureMSL = null !== (_b = result.PressureMSL) && void 0 !== _b ? _b : element.values.PressureMSL;
                    result.Temperature2m = null !== (_c = result.Temperature2m) && void 0 !== _c ? _c : element.values.Temperature2m;
                    result.WindDirection = null !== (_d = result.WindDirection) && void 0 !== _d ? _d : element.values.WindDirection;
                    result.RelativeHumidity = null !== (_e = result.RelativeHumidity) && void 0 !== _e ? _e : element.values.RelativeHumidity;
                    result.WindSpeed10m = null !== (_f = result.WindSpeed10m) && void 0 !== _f ? _f : element.values.WindSpeed10m;
                }
                return result;
            }
            ResolveDailyCondition(hourlyData, date) {
                const target = date.set({
                    hour: 6
                });
                const upto = target.plus({
                    days: 1
                });
                const relevantHours = hourlyData.filter((x => {
                    const hour = DateTime.fromJSDate(this.DateStringToDate(x.time), {
                        zone: target.zoneName
                    });
                    if (hour >= target && hour < upto) return true;
                    return false;
                }));
                const normalizedSymbols = relevantHours.map((x => x.symbol > 100 ? x.symbol - 100 : x.symbol));
                let resultSymbol;
                if (!!normalizedSymbols.find((x => x > 10 && 45 != x))) resultSymbol = Math.max(...normalizedSymbols); else resultSymbol = mode(normalizedSymbols);
            ...
            GetLocationBoundingBox(loc) {
                this.observationParams.west = loc.lon + .075;
                this.observationParams.east = loc.lon - .075;
                this.observationParams.north = loc.lat + .045;
                this.observationParams.south = loc.lat - .04;
            }
            OrderObservations(observations, loc) {
                const result = [];
                for (const key in observations) {
                    const element = observations[key];
                    result.push(Object.assign(Object.assign({}, element), {
            ...
            DateStringToDate(str) {
                if (14 == str.length) return new Date(Date.UTC(parseInt(str.substring(0, 4)), parseInt(str.substring(4, 6)) - 1, parseInt(str.substring(6, 8)), parseInt(str.substring(8, 10)), parseInt(str.substring(10, 12)), parseInt(str.substring(12, 14)))); else if (8 == str.length) return new Date(Date.UTC(parseInt(str.substring(0, 4)), parseInt(str.substring(4, 6)) - 1, parseInt(str.substring(6, 8)), 0, 0, 0, 0)); else {
                    if (3 == str.length) str = ("0000" + str).substr(-4, 4);
        ...
        class AccuWeather extends BaseProvider {
            get remainingCalls() {
                return null == this.remainingQuota ? null : Math.floor(this.remainingQuota / 3);
            }
            get dailyForecastUrl() {
                let url = this.baseUrl + "forecasts/v1/daily/";
                if ("free" == this.tier || "standard" == this.tier) url += "5day/"; else if ("prime" == this.tier) url += "10day/"; else url += "10day/";
                return url;
            }
            get hourlyForecastUrl() {
                let url = this.baseUrl + "forecasts/v1/hourly/";
                if ("free" == this.tier || "standard" == this.tier) url += "12hour/"; else if ("prime" == this.tier) url += "72hour/"; else url += "120hour";
                return url;
            }
            async GetWeather(loc) {
                var _a, _b;
                const locationID = `${loc.lat},${loc.lon}`;
                const userLocale = null !== (_b = null === (_a = this.app.config.currentLocale) || void 0 === _a ? void 0 : _a.toLowerCase()) && void 0 !== _b ? _b : "en-us";
                const locale = this.app.config._translateCondition ? userLocale : "en-us";
                let location;
                if (null != this.locationCache[locationID]) location = this.locationCache[locationID]; else location = await this.app.LoadJsonAsync(this.locSearchUrl, {
                    q: locationID,
                    details: true,
                    language: userLocale,
                ...
                const [current, forecast, hourly] = await Promise.all([ this.app.LoadJsonAsyncWithDetails(this.currentConditionUrl + location.Key, {
                    apikey: this.app.config.ApiKey,
                    details: true,
                    language: locale
                }, this.HandleErrors), this.app.LoadJsonAsyncWithDetails(this.dailyForecastUrl + location.Key, {
                    apikey: this.app.config.ApiKey,
                    details: true,
                    metric: true,
                    language: locale
                }, this.HandleErrors), this.app.LoadJsonAsyncWithDetails(this.hourlyForecastUrl + location.Key, {
                    apikey: this.app.config.ApiKey,
                    details: true,
                    metric: true,
                    language: locale
                }, this.HandleErrors) ]);
                if (!current.Success || !forecast.Success || !hourly.Success) return null;
            ...
            SetTier(limit) {
                if (limit > 18e5) this.tier = "elite"; else if (limit > 225e3) this.tier = "prime"; else if (limit > 50) this.tier = "standard"; else this.tier = "free";
            }
            ParseWeather(current, daily, hourly, loc) {
                ...
                return {
                    ...
                    dewPoint: CelsiusToKelvin(null === (_b = null === (_a = current.DewPoint) || void 0 === _a ? void 0 : _a.Metric) || void 0 === _b ? void 0 : _b.Value),
                    humidity: current.RelativeHumidity,
                    pressure: null === (_d = null === (_c = current.Pressure) || void 0 === _c ? void 0 : _c.Metric) || void 0 === _d ? void 0 : _d.Value,
                    location: {
                    ...
                    temperature: CelsiusToKelvin(null === (_f = null === (_e = current.Temperature) || void 0 === _e ? void 0 : _e.Metric) || void 0 === _f ? void 0 : _f.Value),
                    wind: {
                        degree: null === (_h = null === (_g = current.Wind) || void 0 === _g ? void 0 : _g.Direction) || void 0 === _h ? void 0 : _h.Degrees,
                        speed: KPHtoMPS(null === (_l = null === (_k = null === (_j = current.Wind) || void 0 === _j ? void 0 : _j.Speed) || void 0 === _k ? void 0 : _k.Metric) || void 0 === _l ? void 0 : _l.Value)
                    },
                    condition: Object.assign(Object.assign({}, this.ResolveIcons(current.WeatherIcon, current.IsDayTime)), {
            ...
            ParseHourly(hourly) {
                ...
                for (const hour of hourly) {
                    let precipitation;
                    if (null !== (_a = hour.PrecipitationProbability) && void 0 !== _a ? _a : 0 > 0) switch (hour.PrecipitationType) {
                      case "Rain":
                        precipitation = {
                            type: "rain",
                            chance: hour.RainProbability,
                            volume: null !== (_c = null === (_b = null === hour || void 0 === hour ? void 0 : hour.Rain) || void 0 === _b ? void 0 : _b.Value) && void 0 !== _c ? _c : void 0
                        };
                        break;
                      ...
                      case "Snow":
                        precipitation = {
                            ...
                            volume: null !== (_e = null === (_d = null === hour || void 0 === hour ? void 0 : hour.Snow) || void 0 === _d ? void 0 : _d.Value) && void 0 !== _e ? _e : void 0
                        };
                        break;
                      ...
                      case "Ice":
                        precipitation = {
                            ...
                            volume: null !== (_g = null === (_f = null === hour || void 0 === hour ? void 0 : hour.Ice) || void 0 === _f ? void 0 : _f.Value) && void 0 !== _g ? _g : void 0
                        };
                        break;
                    }
                    hours.push({
                        date: DateTime.fromISO(hour.DateTime),
                        condition: Object.assign(Object.assign({}, this.ResolveIcons(hour.WeatherIcon, hour.IsDaylight)), {
            ...
            ParseDaily(daysPayload) {
                const days = [];
                for (const day of daysPayload.DailyForecasts) days.push({
                    ...
                    condition: Object.assign(Object.assign({}, this.ResolveIcons(day.Day.Icon, true)), {
        ...
        class DeutscherWetterdienst extends BaseProvider {
            ...
            async GetWeather(loc) {
                var _a, _b, _c, _d;
                const [current, hourly] = await Promise.all([ this.app.LoadJsonAsync(`${this.baseUrl}current_weather`, this.GetDefaultParams(loc), this.HandleErrors), this.app.LoadJsonAsync(`${this.baseUrl}weather`, this.GetHourlyParams(loc), this.HandleErrors) ]);
                if (null == current || null == hourly) return null;
                ...
                const mainSource = null !== (_a = current.sources.find((source => source.id == current.weather.source_id))) && void 0 !== _a ? _a : current.sources[0];
                return {
                    date: DateTime.fromISO(current.weather.timestamp).setZone(loc.timeZone),
                    location: {
                        city: null !== (_c = null !== (_b = loc.city) && void 0 !== _b ? _b : current.sources[0].station_name) && void 0 !== _c ? _c : void 0,
                        country: loc.country,
                    ...
                    stationInfo: {
                        ...
                        lat: mainSource.lat,
                        lon: mainSource.lon,
                        name: null !== (_d = mainSource.station_name) && void 0 !== _d ? _d : void 0
                    },
            ...
            ParseForecast(current, forecast, loc) {
                ...
                for (const day of days) {
                    ...
                    for (const hour of day) {
                        if (null == time) time = DateTime.fromISO(hour.timestamp).setZone(loc.timeZone);
                        if (null != hour.icon) conditions.push(hour.icon);
                        if (null != hour.temperature) {
                            tempMax = Math.max(tempMax, hour.temperature);
                            tempMin = Math.min(tempMin, hour.temperature);
                        }
                    }
                    if (null == time || tempMin == 1 / 0 || tempMax == -1 / 0) break;
                    result.push({
                        date: time.set({
                            hour: 12,
                            minute: 0,
            ...
            SplitToDays(forecast, loc) {
                const now = DateTime.now().setZone(loc.timeZone).set({
                    minute: 0,
                    second: 0,
                    millisecond: 0
                });
                ...
                for (const hour of forecast.weather) {
                    ...
                    if (prevTimeStamp.hasSame(time, "day")) currentDay.push(hour); else {
            ...
            CalculateDayCondition(conditions) {
                ...
                for (let i = 0; i < conditions.length; i++) {
                    ...
                    if ("clear-night" == condition) conditions[i] = "clear-day";
                    if ("partly-cloudy-night" == condition) conditions[i] = "partly-cloudy-day";
                }
                ...
                for (const condition of conditions) if (regularConditions.includes(condition)) null == regularWeather[condition] ? regularWeather[condition] = 0 : regularWeather[condition]++; else null == severeWeathers[condition] ? severeWeathers[condition] = 0 : severeWeathers[condition]++;
            ...
            ParseHourlyForecast(forecast, loc) {
                ...
                for (const hour of forecast.weather) {
                    ...
                    if (null != hour.precipitation && hour.precipitation > 0 && null != hour.condition && [ "snow", "rain" ].includes(hour.condition)) data.precipitation = {
        ...
        class WeatherUnderground extends BaseProvider {
            constructor() {
                ...
                this.GetWeather = async loc => {
                    ...
                    const location = null !== (_a = this.locationCache[locString]) && void 0 !== _a ? _a : await this.GetNearbyStations(loc);
                    if (null == location) return null;
                    this.locationCache[locString] = location;
                    const forecast = await this.app.LoadJsonAsync(`${this.baseURl}v3/wx/forecast/daily/5day`, {
                        geocode: locString,
                        language: null !== (_b = this.app.config.currentLocale) && void 0 !== _b ? _b : "en-US",
                        format: "json",
                        apiKey: this.app.config.ApiKey,
                        units: this.currentUnit
                    });
                    if (null == forecast) return null;
                    const observation = await this.GetObservations(location, forecast, loc);
                    return {
                        date: observation.date,
                        temperature: null !== (_c = observation.temperature) && void 0 !== _c ? _c : null,
                        coord: {
                            lat: loc.lat,
                            lon: loc.lon
                        },
                        location: {
                            city: null !== (_d = loc.city) && void 0 !== _d ? _d : observation.location.city,
                            country: null !== (_e = loc.country) && void 0 !== _e ? _e : observation.location.country,
                            url: observation.location.url
                        },
                        condition: null !== (_f = observation.condition) && void 0 !== _f ? _f : {
                            description: "unknown",
                            customIcon: "alien-symbolic",
                            icons: [],
                            main: "Unknown"
                        },
                        dewPoint: null !== (_g = observation.dewPoint) && void 0 !== _g ? _g : null,
                        humidity: null !== (_h = observation.humidity) && void 0 !== _h ? _h : null,
                        pressure: null !== (_j = observation.pressure) && void 0 !== _j ? _j : null,
                        wind: {
                            speed: null !== (_k = observation.wind.speed) && void 0 !== _k ? _k : null,
                            degree: null !== (_l = observation.wind.degree) && void 0 !== _l ? _l : null
                        },
                ...
                this.GetNearbyStations = async loc => {
                    ...
                    for (let i = 0; i < payload.location.stationId.length; i++) {
                        ...
                        if (null == stationID) continue;
                        result.push({
                            stationId: stationID,
                            stationName: payload.location.stationName[i],
                            latitude: payload.location.latitude[i],
                            longitude: payload.location.longitude[i],
                            distanceKm: null !== (_a = payload.location.distanceKm[i]) && void 0 !== _a ? _a : GetDistance(loc.lat, loc.lon, payload.location.latitude[i], payload.location.longitude[i]) / 1e3
                        });
                    }
                ...
                this.GetObservations = async (stations, forecast, loc) => {
                    var _a;
                    const observationData = (await Promise.all(stations.map((v => this.GetObservation(v.stationId))))).filter((v => null != v));
                    ...
                    for (const observations of observationData) {
                        ...
                        if (null == result.date && null != observations.obsTimeUtc) result.date = DateTime.fromISO(observations.obsTimeUtc).setZone(tz);
                        if (null == result.location.city && null != observations.neighborhood) result.location.city = observations.neighborhood;
                        if (null == result.location.country && null != observations.country) result.location.country = observations.country;
                        if (null == result.location.url) result.location.url = `https://www.wunderground.com/weather/${observations.stationID}`;
                        if (null == result.temperature && observations.metric_si.temp) result.temperature = CelsiusToKelvin(observations.metric_si.temp);
                        if (null == result.pressure) result.pressure = observations.metric_si.pressure;
                        if (null == result.humidity) result.humidity = observations.humidity;
                        if (null == result.wind.speed) result.wind.speed = observations.metric_si.windSpeed;
                        if (null == result.wind.degree) result.wind.degree = observations.winddir;
                        if (null == result.dewPoint) result.dewPoint = CelsiusToKelvin(observations.metric_si.dewpt);
                        if (null == (null === (_a = result.extra_field) || void 0 === _a ? void 0 : _a.value) && null != observations.metric_si.windChill) result.extra_field = {
                            name: _("Feels Like"),
                            type: "temperature",
                            value: CelsiusToKelvin(observations.metric_si.windChill)
                        };
                        if (null == result.stationInfo) result.stationInfo = {
                            name: station.stationName,
                            lat: station.latitude,
                            lon: station.longitude,
                            distanceFrom: 1e3 * station.distanceKm
                        };
                        if (null == result.immediatePrecipitation) ;
                    }
                    const dayPartIndex = forecast.daypart[0].daypartName.findIndex((v => null != v));
                    if (null == result.date) result.date = DateTime.now().setZone(tz);
                    if (null == result.temperature) result.temperature = this.ToKelvin(forecast.daypart[0].temperature[dayPartIndex]);
                    if (null == result.humidity) result.humidity = forecast.daypart[0].relativeHumidity[dayPartIndex];
                    if (null == result.wind.speed) result.wind.speed = forecast.daypart[0].windSpeed[dayPartIndex];
                    if (null == result.wind.degree) result.wind.degree = forecast.daypart[0].windDirection[dayPartIndex];
                    if (null == result.condition) {
                        const icon = forecast.daypart[0].iconCode[dayPartIndex];
                        if (null != icon) result.condition = this.IconToCondition(icon);
                    }
                ...
                this.GetObservation = async stationID => {
                    ...
                    return null !== (_a = null === observation || void 0 === observation ? void 0 : observation.observations[0]) && void 0 !== _a ? _a : null;
                };
                this.HandleErrors = message => {
            ...
            get currentUnit() {
                var _a;
                if ("fahrenheit" == this.app.config.TemperatureUnit) return "e";
                if (null == this.app.config.countryCode) return "m"; else return null !== (_a = unitTypeMap[this.app.config.countryCode.toLowerCase()]) && void 0 !== _a ? _a : "m";
            }
            ParseForecasts(loc, forecast) {
                var _a;
                const result = [];
                for (let index = 0; index < forecast.dayOfWeek.length; index++) {
                    const icons = [ forecast.daypart[0].iconCode[2 * index], forecast.daypart[0].iconCode[2 * index + 1] ];
                    const data = {
                        date: DateTime.fromSeconds(forecast.validTimeUtc[index]).setZone(loc.timeZone),
                        condition: this.IconToCondition(null !== (_a = icons[0]) && void 0 !== _a ? _a : icons[1]),
                        temp_max: null == forecast.temperatureMax[index] ? null : this.ToKelvin(forecast.temperatureMax[index]),
                        temp_min: null == forecast.temperatureMin[index] ? null : this.ToKelvin(forecast.temperatureMin[index])
                    };
                    if (!this.app.config._shortConditions) data.condition.description = forecast.narrative[index];
                    result.push(data);
                }
                return result;
            }
        ...
        class PirateWeather extends BaseProvider {
            ...
            constructor(_app) {
                ...
                this.HandleError = message => {
                    if (403 == message.ErrorData.code) {
                        ...
                        return false;
                    } else if (401 == message.ErrorData.code) {
                        this.app.ShowError({
                            type: "hard",
                            userError: true,
                            detail: "no key",
            ...
            ParseWeather(json, unit) {
                try {
                    const sunrise = DateTime.fromSeconds(json.daily.data[0].sunriseTime, {
                        zone: json.timezone
                    });
                    const sunset = DateTime.fromSeconds(json.daily.data[0].sunsetTime, {
                        zone: json.timezone
                    });
                    const result = {
                        date: DateTime.fromSeconds(json.currently.time, {
                            zone: json.timezone
                        }),
                        coord: {
                            lat: json.latitude,
                    ...
                    for (const day of json.daily.data) {
                        ...
                        forecast.date = forecast.date.set({
                            hour: 12
                        });
                    ...
                    for (const hour of json.hourly.data) {
                        const forecast = {
                            ...
                            condition: {
                                ...
                                icons: this.ResolveIcon(hour.icon, {
                                    sunrise,
                                    sunset
                            ...
                            precipitation: {
                                ...
                                chance: 100 * hour.precipProbability
                            }
                        };
                    ...
                    if (null != json.minutely) {
                        ...
                        for (const [index, element] of json.minutely.data.entries()) if (element.precipProbability > 0 && -1 == immediate.start) {
                            immediate.start = index;
                            continue;
                        } else if (0 == element.precipProbability && -1 != immediate.start) {
                            immediate.end = index;
                            break;
                        }
                        result.immediatePrecipitation = immediate;
                    ...
                    if (e instanceof Error) logger_Logger.Error("Pirate Weather payload parsing error: " + e, e);
                    this.app.ShowError({
                        type: "soft",
                        detail: "unusual payload",
                        service: "PirateWeather",
            ...
            GetQueryUnit() {
                if ("celsius" == this.app.config.TemperatureUnit) if ("kph" == this.app.config.WindSpeedUnit || "m/s" == this.app.config.WindSpeedUnit) return "si"; else return "uk2"; else return "us";
            }
            ToKelvin(temp, unit) {
                if ("us" == unit) return FahrenheitToKelvin(temp); else return CelsiusToKelvin(temp);
            }
            ToMPS(speed, unit) {
                if ("si" == unit) return speed; else return MPHtoMPS(speed);
            }
        }
        // CONCATENATED MODULE: ./src/3_8/providers/open_meteo/openMeteo.ts
        class OpenMeteo extends BaseProvider {
            constructor() {
                ...
                this.name = "OpenMeteo";
                this.maxForecastSupport = 16;
                this.maxHourlyForecastSupport = 300;
            ...
            async GetWeather(loc) {
                ...
                const result = await this.app.LoadJsonAsync(this.baseUrl, params);
                if (!result) return null;
                return this.ParseWeatherData(result);
            }
            ParseWeatherData(data) {
                const time = DateTime.fromSeconds(data.current_weather.time, {
                    zone: data.timezone
                });
                const currentHourIndex = data.hourly.time.findIndex((t => t > data.current_weather.time)) - 1;
                const sunTimes = (0, suncalc.getTimes)(time.toJSDate(), data.latitude, data.longitude, data.elevation);
                try {
                    const result = {
                        date: time,
                        coord: {
                    ...
                    for (let i = currentHourIndex; i < data.hourly.time.length; i++) {
                        ...
                        const hourTime = DateTime.fromSeconds(time, {
                            zone: data.timezone
                        });
                        const hour = {
                            date: hourTime,
                        ...
                        const types = [ "rain", "rain", "snow" ];
                        const precipValues = [ rain, showers, snowfall ];
                        if (precipitation_probability > .1) {
                    ...
                    if (err instanceof Error) logger_Logger.Error("Open-Meteo Weather Parsing error: " + err, err);
                    this.app.ShowError({
                        type: "soft",
                        service: "OpenMeteo",
                        detail: "unusual payload",
            ...
            ResolveCondition(weathercode, is_day = true) {
                switch (weathercode) {
                  default:
                    return {
                        main: "Test",
        ...
        class Config {
            get UserTimezone() {
                ...
                if (null == timezone.get_identifier) return DateTime.now().zoneName; else return TimeZone.new_local().get_identifier();
            }
            get Timezone() {
            ...
            constructor(app, instanceID) {
                ...
                this.OnKeySettingsUpdated = () => {
                    if (null != this.keybinding) keybindingManager.addHotKey(UUID, this.keybinding, Lang.bind(this.app, this.app.on_applet_clicked));
                };
                ...
                this.OnLocationChanged = () => {
                    ...
                    if (null != this.doneTypingLocation) utils_clearTimeout(this.doneTypingLocation);
                    this.doneTypingLocation = utils_setTimeout(Lang.bind(this, this.DoneTypingLocation), 3e3);
                };
                ...
                this.InterfaceSettings = new config_Settings({
            ...
            get TemperatureUnit() {
                if ("automatic" == this._temperatureUnit) return this.GetLocaleTemperateUnit(this.UserTimezone);
                return this._temperatureUnit;
            }
            get WindSpeedUnit() {
                if ("automatic" == this._windSpeedUnit) return this.GetLocaleWindSpeedUnit(this.UserTimezone);
                return this._windSpeedUnit;
            }
            get DistanceUnit() {
                if ("automatic" == this._distanceUnit) return this.GetLocaleDistanceUnit(this.UserTimezone);
                return this._distanceUnit;
            }
            get IconType() {
                if (this._useCustomMenuIcons) return config_IconType.SYMBOLIC;
                return this._useSymbolicIcons ? config_IconType.SYMBOLIC : config_IconType.FULLCOLOR;
            }
            get AppletIconType() {
                if (this._useCustomAppletIcons) return config_IconType.SYMBOLIC;
                return this._useSymbolicIcons ? config_IconType.SYMBOLIC : config_IconType.FULLCOLOR;
            }
            SwitchToNextLocation() {
                const nextLoc = this.LocStore.GetNextLocation(this.CurrentLocation);
                if (null == nextLoc) return null;
            ...
            SwitchToPreviousLocation() {
                ...
                if (null == previousLoc) return null;
                this.InjectLocationToConfig(previousLoc, true);
                return previousLoc;
            }
            NoApiKey() {
                var _a;
                const key = null === (_a = this._apiKey) || void 0 === _a ? void 0 : _a.replace(" ", "");
                return !key || "" == key;
            }
            async EnsureLocation() {
                ...
                if (null == locationData) return null;
                if (!!(null === locationData || void 0 === locationData ? void 0 : locationData.entryText)) logger_Logger.Debug("Address found via address search");
            ...
            BindSettings() {
                let key;
                for (key in Keys) if (Object.prototype.hasOwnProperty.call(Keys, key)) {
            ...
            InjectLocationToConfig(loc, switchToManual = false) {
                ...
                if (true == switchToManual) this.settings.setValue(Keys.MANUAL_LOCATION.key, true);
            }
            DoneTypingLocation() {
            ...
            GetLocaleTemperateUnit(code) {
                if (null == code || !fahrenheitCountries.includes(code)) return "celsius";
                return "fahrenheit";
            }
            GetLocaleWindSpeedUnit(code) {
                var _a;
                if (null == code) return "kph";
                let key;
                for (key in windSpeedUnitLocales) if (null === (_a = windSpeedUnitLocales[key]) || void 0 === _a ? void 0 : _a.includes(code)) return key;
                return "kph";
            }
            GetLocaleDistanceUnit(code) {
                var _a;
                if (null == code) return "metric";
                let key;
                for (key in distanceUnitLocales) if (null === (_a = distanceUnitLocales[key]) || void 0 === _a ? void 0 : _a.includes(code)) return key;
                return "metric";
            }
            ...
            async GetAppletConfigJson() {
                var _a, _b, _c, _d, _e;
                const home = null !== (_a = config_get_home_dir()) && void 0 !== _a ? _a : "~";
                ...
                if (!await FileExists(configFile)) {
                    ...
                    if (!await FileExists(configFile)) throw new Error(_("Could not retrieve config, file was not found under paths\n {configFilePath}", {
                        configFilePath: `${configFilePath}\n${oldConfigFilePath}`
                    }));
                }
                const confString = await LoadContents(configFile);
                if (null == confString) throw new Error(_("Could not get contents of config file under path\n {configFilePath}", {
                    configFilePath
                }));
                const conf = JSON.parse(confString);
                if (null != (null === (_b = null === conf || void 0 === conf ? void 0 : conf.apiKey) || void 0 === _b ? void 0 : _b.value)) conf.apiKey.value = "REDACTED";
                for (const item of null !== (_d = null === (_c = null === conf || void 0 === conf ? void 0 : conf.locationList) || void 0 === _c ? void 0 : _c.value) && void 0 !== _d ? _d : []) {
                    item.lat = "REDACTED";
                    item.lon = "REDACTED";
                    item.city = "REDACTED";
                    item.entryText = "REDACTED";
                }
                if (null != (null === (_e = null === conf || void 0 === conf ? void 0 : conf.location) || void 0 === _e ? void 0 : _e.value)) conf.location.value = "REDACTED";
                return conf;
            }
            Destroy() {
                var _a, _b;
                null === (_b = (_a = this.settings).finalize) || void 0 === _b ? void 0 : _b.call(_a);
            }
        }
        const Keys = {
            DATA_SERVICE: {
        ...
        class WeatherLoop {
            constructor(app, instanceID) {
                ...
                this.DoCheck = async () => {
                    ...
                    try {
                        this.updating = true;
                        if (true == this.app.encounteredError) this.IncrementErrorCount();
                        ...
                        if (this.errorCount > 0 || this.NextUpdate() < new Date) {
                            logger_Logger.Debug("Refresh triggered in main loop with these values: lastUpdated " + (!this.lastUpdated ? "null" : this.lastUpdated.toLocaleString()) + ", errorCount " + this.errorCount.toString() + " , loopInterval " + (this.LoopInterval() / 1e3).toString() + " seconds, refreshInterval " + this.app.config._refreshInterval + " minutes");
                            const state = await this.app.RefreshWeather(false, null, false);
                            if ("error" == state) logger_Logger.Info("App is currently refreshing, refresh skipped in main loop");
                            if ("success" == state || "locked") this.lastUpdated = new Date;
                        } else logger_Logger.Debug("No need to update yet, skipping");
                    } catch (e) {
                        if (e instanceof Error) logger_Logger.Error("Error in Main loop: " + e, e);
            ...
            IsDataTooOld() {
                ...
                oldDate.setMinutes(oldDate.getMinutes() + 2 * this.app.config._refreshInterval);
            ...
            IsStray() {
                if (true == this.appletRemoved) return true;
            ...
            NextUpdate() {
                return new Date(this.lastUpdated.getTime() + 6e4 * this.app.config._refreshInterval);
            }
            ValidateLastUpdateTime() {
                if (this.lastUpdated > new Date) this.lastUpdated = new Date(0);
            }
            LoopInterval() {
                return this.errorCount > 0 ? this.LOOP_INTERVAL * this.errorCount * 1e3 : 1e3 * this.LOOP_INTERVAL;
            }
        }
        ...
        async function SpawnProcess(command) {
            let cmd = "";
            for (const element of command) cmd += "'" + element + "' ";
            const response = await new Promise(((resolve, reject) => {
                spawnCommandLineAsyncIO(cmd, ((aStdout, err, exitCode) => {
                    let result = {
                        Success: 0 == exitCode,
                        ErrorData: void 0,
                        Data: null !== aStdout && void 0 !== aStdout ? aStdout : null
                    };
                    if (0 != exitCode) result.ErrorData = {
                        Code: exitCode,
                        Message: null !== err && void 0 !== err ? err : null,
                        Type: "unknown"
                    };
                    resolve(result);
                    return result;
        ...
        class WeatherButton {
            constructor(options, doNotAddPadding = false) {
                ...
                if (doNotAddPadding) this.actor.set_style("padding: 0px; border-radius: 2px;"); else this.actor.set_style("padding-top: 0px;padding-bottom: 0px; padding-right: 2px; padding-left: 2px; border-radius: 2px;");
        ...
        class SunTimesUI {
            ...
            Display(sunrise, sunset, tz) {
                if (!this.app.config._showSunrise || null == sunrise || null == sunset) {
                    this.actor.hide();
                    return;
                }
        ...
        class WindBox {
            constructor(app) {
                ...
                this.OnDisplayWindAsTextChanged = (config, displayWindAsText, data) => {
                    ...
                    if (!displayWindAsText) this._label.add(this.windDirectionIcon, {
                        x_fill: false,
                        y_fill: true,
                        x_align: windBox_Align.MIDDLE,
                        y_align: windBox_Align.MIDDLE,
                        expand: false
                    });
            ...
            Rebuild(config, textColorStyle) {
                this._caption = new windBox_Label({
            ...
            BuildLabel(config) {
                const windBox = new windBox_BoxLayout({
                    vertical: false
                });
                const iconPaddingBottom = Math.round(.05 * config.CurrentFontSize);
                const iconPaddingTop = Math.round(.15 * config.CurrentFontSize);
                const iconSize = Math.round(.8 * config.CurrentFontSize);
                this.labelText = new windBox_Label({
                    text: ELLIPSIS,
                    x_expand: true,
                    x_align: windBox_ActorAlign.FILL
                });
                ...
                if (!config._displayWindAsText) windBox.add(this.windDirectionIcon, {
                    x_fill: false,
                    y_fill: true,
                    x_align: windBox_Align.MIDDLE,
                    y_align: windBox_Align.MIDDLE,
            ...
            Display(windSpeed, windDegree) {
                if (null == windSpeed || null == windDegree) {
                    this._caption.hide();
                    this._label.hide();
                    return;
                }
                ...
                if (this.app.config._displayWindAsText) {
                    ...
                    this.labelText.text = `${null != dirText ? _(dirText) + " " : ""}${MPStoUserUnits(windSpeed, this.app.config.WindSpeedUnit)}`;
                } else this.labelText.text = MPStoUserUnits(windSpeed, this.app.config.WindSpeedUnit);
                if ("Beaufort" != this.app.config.WindSpeedUnit) this.labelText.text += " " + _(this.app.config.WindSpeedUnit);
                this._caption.show();
                this._label.show();
            }
        }
        ...
        class CurrentWeather {
            ...
            Display(weather, config) {
                try {
                    if (this.app.config.LocStore.ShouldShowLocationSelectors(config.CurrentLocation)) this.ShowLocationSelectors(); else this.HideLocationSelectors();
                    ...
                    if (e instanceof Error) logger_Logger.Error("DisplayWeatherError: " + e, e);
                    return false;
                }
            }
            ...
            BuildMiddleColumn(config, textColorStyle) {
                this.weatherSummary = new uiCurrentWeather_Label({
                    text: _("Loading ..."),
                    style_class: STYLE_SUMMARY
                });
                const middleColumn = new uiCurrentWeather_BoxLayout({
                    vertical: true,
                    style_class: STYLE_SUMMARYBOX
                });
                middleColumn.add(this.BuildLocationSection());
                middleColumn.add(this.weatherSummary, {
                    expand: true,
                    x_align: uiCurrentWeather_Align.MIDDLE,
                    y_align: uiCurrentWeather_Align.MIDDLE,
                    x_fill: false,
                    y_fill: false
                });
                this.immediatePrecipitationLabel = new uiCurrentWeather_Label({
                    style_class: "weather-immediate-precipitation"
                });
                this.immediatePrecipitationBox = new uiCurrentWeather_BoxLayout({
                    x_align: uiCurrentWeather_ActorAlign.CENTER
                });
            ...
            BuildRightColumn(textColorStyle, config) {
                ...
                this.dewPointLabel = new uiCurrentWeather_Label({
                    text: ""
                });
                this.apiUniqueLabel = new uiCurrentWeather_Label({
                    text: ""
                });
                this.temperatureCaption = new uiCurrentWeather_Label({
                    text: _("Temperature") + LocalizedColon(config.currentLocale),
                    style: textColorStyle
                });
                this.humidityCaption = new uiCurrentWeather_Label({
                    text: _("Humidity") + LocalizedColon(config.currentLocale),
                    style: textColorStyle
                });
                this.pressureCaption = new uiCurrentWeather_Label({
                    text: _("Pressure") + LocalizedColon(config.currentLocale),
                    style: textColorStyle
                });
                this.dewPointCaption = new uiCurrentWeather_Label({
                    text: _("Dew Point") + LocalizedColon(config.currentLocale),
                    style: textColorStyle
                });
                this.apiUniqueCaption = new uiCurrentWeather_Label({
                    text: "",
                    style: textColorStyle
                });
                const [windCaption, windLabel] = this.windBox.Rebuild(config, textColorStyle);
                const rb_captions = new uiCurrentWeather_BoxLayout({
                    vertical: true,
            ...
            BuildLocationSection() {
                ...
                this.location.connect(SIGNAL_CLICKED, (() => {
                    if (this.app.encounteredError) this.app.RefreshWeather(true); else if (null == this.locationButton.url) return; else OpenUrl(this.locationButton);
                }));
                ...
                box.add(this.previousLocationButton.actor, {
                    x_fill: false,
                    x_align: uiCurrentWeather_Align.START,
                    y_align: uiCurrentWeather_Align.MIDDLE,
                    expand: false
                });
                ...
                box.add(this.nextLocationButton.actor, {
                    x_fill: false,
                    x_align: uiCurrentWeather_Align.END,
                    y_align: uiCurrentWeather_Align.MIDDLE,
                    expand: false
                });
                return box;
            ...
            SetImmediatePrecipitation(precip, config) {
                if (!config._immediatePrecip || !precip || null == precip.end || null == precip.start) {
                    this.immediatePrecipitationBox.hide();
                    return;
                }
                this.immediatePrecipitationBox.show();
                if (-1 == precip.start) this.immediatePrecipitationBox.hide(); else if (0 == precip.start) if (-1 != precip.end) this.immediatePrecipitationLabel.text = _("Precipitation will end in {precipEnd} minutes", {
                    precipEnd: precip.end
                }); else this.immediatePrecipitationLabel.text = _("Precipitation won't end in within an hour"); else this.immediatePrecipitationLabel.text = _("Precipitation will start within {precipStart} minutes", {
                    precipStart: precip.start
                });
            }
            SetAPIUniqueField(extra_field) {
                ...
                this.apiUniqueLabel.text = null !== value && void 0 !== value ? value : "";
            ...
            SetLocation(locationString, url) {
                ...
                if (!url) this.locationButton.disable(); else this.locationButton.url = url;
            }
            NextLocationClicked() {
            ...
            onLocationStorageChanged(sender, itemCount) {
                ...
                if (this.app.config.LocStore.ShouldShowLocationSelectors(this.app.config.CurrentLocation)) this.ShowLocationSelectors(); else this.HideLocationSelectors();
            }
            ShowLocationSelectors() {
                var _a, _b, _c, _d;
                null === (_b = null === (_a = this.nextLocationButton) || void 0 === _a ? void 0 : _a.actor) || void 0 === _b ? void 0 : _b.show();
                null === (_d = null === (_c = this.previousLocationButton) || void 0 === _c ? void 0 : _c.actor) || void 0 === _d ? void 0 : _d.show();
            }
            HideLocationSelectors() {
                var _a, _b, _c, _d;
                null === (_b = null === (_a = this.nextLocationButton) || void 0 === _a ? void 0 : _a.actor) || void 0 === _b ? void 0 : _b.hide();
                null === (_d = null === (_c = this.previousLocationButton) || void 0 === _c ? void 0 : _c.actor) || void 0 === _d ? void 0 : _d.hide();
            }
        }
        ...
        class UIForecasts {
            constructor(app) {
                ...
                this.OnForecastDaysChanged = async (config, forecastDays, data) => {
                    if (null == config.textColorStyle) return;
                    this.Rebuild(config, config.textColorStyle);
                    this.Display(data, config);
                };
                this.app = app;
                this.actor = new uiForecasts_Bin({
            ...
            UpdateIconType(iconType) {
                ...
                for (const forecast of this.forecasts) {
                    if (!(null === forecast || void 0 === forecast ? void 0 : forecast.Icon)) continue;
            ...
            Display(weather, config) {
                try {
                    ...
                    if (this.forecasts.length > weather.forecasts.length) this.Rebuild(this.app.config, this.app.config.textColorStyle, weather.forecasts.length);
                    ...
                    for (let i = 0; i < len; i++) {
                        ...
                        if (null != weather.hourlyForecasts) for (let index = 0; index < this.app.GetMaxHourlyForecasts(); index++) {
                    ...
                    if (e instanceof Error) logger_Logger.Error("DisplayForecastError: " + e, e);
                    return false;
                }
            }
            Rebuild(config, textColorStyle, availableHours = null) {
                ...
                const maxDays = null !== availableHours && void 0 !== availableHours ? availableHours : this.app.GetMaxForecastDays();
                let maxRow = config._forecastRows;
                let maxCol = config._forecastColumns;
                if (config._verticalOrientation) [maxRow, maxCol] = [ maxCol, maxRow ];
                let curRow = 0;
                let curCol = 0;
                for (let i = 0; i < maxDays; i++) {
                    ...
                    by.add(forecastWeather.Day.actor, {
                        x_align: imports.gi.St.Align.START,
                        expand: false,
                        x_fill: false
                    });
                    by.add_actor(forecastWeather.Summary);
                    by.add(forecastWeather.Temperature, {
                        expand: true,
                        x_fill: true
                    });
                    ...
                    if (!config._verticalOrientation) this.grid.attach(bb, curCol, curRow, 1, 1); else this.grid.attach(bb, curRow, curCol, 1, 1);
                    curCol++;
                }
            }
            Destroy() {
                if (null != this.actor.get_child()) this.actor.get_child().destroy();
            }
        ...
        class UIHourlyForecasts {
            ...
            constructor(app, menu) {
                ...
                this.OnPaint = owner => {
                    var _a, _b;
                    if (null == this.availableWidth) return;
                    const ctx = owner.get_context();
                    const maxTemp = this.hourlyForecastData.map((x => x.temp)).reduce(((p, c) => Math.max(null !== p && void 0 !== p ? p : 0, null !== c && void 0 !== c ? c : 0)));
                    const minTemp = this.hourlyForecastData.map((x => x.temp)).reduce(((p, c) => Math.min(null !== p && void 0 !== p ? p : 0, null !== c && void 0 !== c ? c : 0)));
                    const maxPrecipVolume = this.hourlyForecastData.map((x => {
                        var _a;
                        return null === (_a = x.precipitation) || void 0 === _a ? void 0 : _a.volume;
                    })).reduce(((p, c) => Math.max(null !== p && void 0 !== p ? p : 0, null !== c && void 0 !== c ? c : 0)));
                    const totalHeight = this.hourlyContainers[0].height;
                    const itemWidth = this.hourlyContainers[0].width;
                    this.hourlyContainers.length;
                    ...
                    for (let i = 0; i < this.hourlyContainers.length; i++) {
                        ...
                        this.hourlyForecasts[i];
                        if (null == data.temp) continue;
                        const ratio = (data.temp - minTemp) / (maxTemp - minTemp) * (this.tempGraphHeight - 2 * tempPadding);
                        ...
                        precipitation.push(null !== (_b = null === (_a = data.precipitation) || void 0 === _a ? void 0 : _a.volume) && void 0 !== _b ? _b : 0);
                    }
                    ctx.setLineWidth(3);
                    if (null == this.app.config.ForegroundColor) ctx.setSourceRGBA(1, 1, 1, .5); else ctx.setSourceRGBA(this.app.config.ForegroundColor.red, this.app.config.ForegroundColor.green, this.app.config.ForegroundColor.blue, this.app.config.ForegroundColor.alpha);
                ...
                this.actor.connect("scroll-event", ((owner, event) => {
                    ...
                    const newVal = adjustment.get_value() + (direction === ScrollDirection.UP ? -adjustment.step_increment : adjustment.step_increment);
                    if (global.settings.get_boolean("desktop-effects-on-menus")) addTween(adjustment, {
                        value: newVal,
                        time: .25
                    }); else adjustment.set_value(newVal);
                    return false;
                }));
                this.actor.hide();
                this.actor.set_clip_to_allocation(true);
                this.container = new uiHourlyForecasts_BoxLayout({
                    style_class: "hourly-box"
                });
            ...
            DateToScrollIndex(date) {
                if (null == this.hourlyForecastDates) return null;
                ...
                for (let index = 0; index < this.hourlyForecastDates.length; index++) {
                    if (OnSameDay(this.hourlyForecastDates[index], date)) midnightIndex = index;
                    if (OnSameDay(this.hourlyForecastDates[index].minus({
                        hours: 6
                    }), date)) return index * itemWidth;
                }
                if (null != midnightIndex) return midnightIndex * itemWidth;
                return null;
            }
            ScrollTo(index, animate = true) {
                ...
                if (global.settings.get_boolean("desktop-effects-on-menus") && animate) addTween(adjustment, {
                    value: index,
                    time: .25
                }); else adjustment.set_value(index);
            }
            UpdateIconType(iconType) {
                if (!this.hourlyForecasts) return;
                for (const hourly of this.hourlyForecasts) {
                    if (!(null === hourly || void 0 === hourly ? void 0 : hourly.Icon)) continue;
                    hourly.Icon.icon_type = iconType;
                }
            }
            Display(forecasts, config, tz) {
                if (!forecasts || !this.hourlyForecasts) return true;
                if (this.hourlyForecasts.length > forecasts.length) this.Rebuild(this.app.config, this.app.config.textColorStyle, forecasts.length);
                ...
                for (let index = 0; index < max; index++) {
                    ...
                    if (0 == hour.date.hour) ui.Hour.text = GetDayName(hour.date, {
                        locale: config.currentLocale,
                        tz,
                        useTodayTomorrow: false,
                        short: true
                    }); else ui.Hour.text = GetHoursMinutes(hour.date, config.currentLocale, config._show24Hours, tz, config._shortHourlyTime);
            ...
            async Hide(animate = true) {
                this.hourlyToggled = false;
                return new Promise(((resolve, reject) => {
                    if (global.settings.get_boolean("desktop-effects-on-menus") && animate) addTween(this.actor, {
                        height: 0,
                        time: .25,
                        onUpdate: () => {},
                        onComplete: () => {
            ...
            AdjustHourlyBoxItemWidth(availableWidth) {
                ...
                for (const element of this.hourlyContainers) element.set_width(requiredWidth);
                null !== availableWidth && void 0 !== availableWidth ? availableWidth : availableWidth = null !== (_a = this.availableWidth) && void 0 !== _a ? _a : void 0;
                if (null != availableWidth) {
                    if (availableWidth - 2 * this.hourlyBoxHorizontalPadding >= this.hourlyContainers.length * requiredWidth) this.actor.hscrollbar_policy = PolicyType.NEVER; else this.actor.hscrollbar_policy = PolicyType.AUTOMATIC;
            ...
            GetHourlyBoxItemWidth() {
                let requiredWidth = 0;
                if (!this.hourlyForecasts) return requiredWidth;
                for (let index = 0; index < this.hourlyContainers.length; index++) {
                    ...
                    if (null == precipitationWidth || null == temperatureWidth || null == hourWidth || null == iconWidth || null == summaryWidth || null == percipVolumeWidth || null == percipChanceWidth) continue;
            ...
            Destroy() {
                ...
                if (this.onPaintSignal) null === (_a = this.canvas) || void 0 === _a ? void 0 : _a.disconnect(this.onPaintSignal);
            }
            Rebuild(config, textColorStyle, availableHours = null) {
                var _a, _b;
                this.Destroy();
                const hours = null !== availableHours && void 0 !== availableHours ? availableHours : this.app.GetMaxHourlyForecasts();
                this.hourlyForecasts = [];
                this.hourlyContainers = [];
                const canvas = new imports.gi.St.DrawingArea;
                const grid = new imports.gi.Clutter.GridLayout;
                const gridActor = new imports.gi.Clutter.Actor({
                    layout_manager: grid
                });
                grid.attach(canvas, 1, 1, 1, 1);
                const forecastContainer = new uiHourlyForecasts_BoxLayout;
                grid.attach(forecastContainer, 1, 1, 1, 1);
                this.container.add(gridActor, {
                    expand: true,
                    x_fill: true,
                    y_fill: true
                });
                for (let index = 0; index < hours; index++) {
                    const box = new uiHourlyForecasts_BoxLayout({
                        vertical: true,
                        style_class: "hourly-box-item"
                    });
                    this.hourlyContainers.push(box);
                    this.hourlyForecasts.push({
                        Hour: new uiHourlyForecasts_Label({
                            text: "Hour",
                        ...
                        Summary: new uiHourlyForecasts_Label({
                            text: _(ELLIPSIS),
                            style_class: "hourly-data"
                        }),
                        PrecipPercent: new uiHourlyForecasts_Label({
                            text: " ",
                            style_class: "hourly-data",
                            style: "padding-top: 5px;"
                        }),
                        PrecipVolume: new uiHourlyForecasts_Label({
                            text: _(ELLIPSIS),
                            style_class: "hourly-data",
                            style: `font-size: 80%; min-width: ${this.volumeGraphWidth}px;`
                        }),
                        Temperature: new uiHourlyForecasts_Label({
                            text: _(ELLIPSIS),
                            style_class: "hourly-data",
                    ...
                    if (null === (_a = this.app.Provider) || void 0 === _a ? void 0 : _a.supportHourlyPrecipChance) box.add_child(this.hourlyForecasts[index].PrecipPercent);
                    if (null === (_b = this.app.Provider) || void 0 === _b ? void 0 : _b.supportHourlyPrecipVolume) box.add_child(this.hourlyForecasts[index].PrecipVolume);
            ...
            GeneratePrecipitationVolume(precip, config) {
                ...
                if (!!precip.volume && precip.volume >= .1) precipitationText = `${MillimeterToUserUnits(precip.volume, config.DistanceUnit)}${"metric" == config.DistanceUnit ? _("mm") : _("in")}`;
            ...
            GeneratePrecipitationChance(precip, config) {
                ...
                if (!!precip.chance) {
                    ...
                    precipitationText += (10 * Math.round(precip.chance / 10)).toString() + "%";
                }
                return precipitationText;
            }
            GetScrollViewHeight() {
                let boxItemHeight = 0;
                if (!this.hourlyForecasts) return boxItemHeight;
                for (let index = 0; index < this.hourlyContainers.length; index++) {
                    const ui = this.hourlyForecasts[index];
                    ...
                    if (null == precipitationHeight || null == temperatureHeight || null == hourHeight || null == iconHeight || null == summaryHeight) continue;
                ...
                return boxItemHeight + (null !== scrollBarHeight && void 0 !== scrollBarHeight ? scrollBarHeight : 0) + styling;
            }
        }
        ...
        class UIBar {
            ...
            constructor(app) {
                ...
                this.app = app;
                this.actor = new uiBar_BoxLayout({
                    vertical: false,
            ...
            SwitchButtonToShow() {
                ...
                if (!!(null === (_a = this.hourlyButton) || void 0 === _a ? void 0 : _a.actor.child)) this.hourlyButton.actor.child.icon_name = icon;
            }
            SwitchButtonToHide() {
                var _a;
            ...
            DisplayErrorMessage(msg) {
                if (null == this._timestamp) return;
                this._timestamp.label = msg;
            }
            Display(weather, provider, config, shouldShowToggle) {
                var _a, _b, _c, _d, _e, _f, _g;
                if (null == this._timestamp || null == this.providerCreditButton || (null === (_c = null === (_a = this.providerCreditButton) || void 0 === _a ? void 0 : (_b = _a.actor).is_finalized) || void 0 === _c ? void 0 : _c.call(_b))) return false;
                let creditLabel = `${_("Powered by")} ${provider.prettyName}`;
                if (null != provider.remainingCalls) creditLabel += ` (${provider.remainingCalls})`;
                this.providerCreditButton.actor.label = creditLabel;
                this.providerCreditButton.url = provider.website;
                const lastUpdatedTime = AwareDateString(weather.date, config.currentLocale, config._show24Hours, DateTime.local().zoneName);
                this._timestamp.label = _("As of {lastUpdatedTime}", {
                    lastUpdatedTime
                });
                if (null != (null === (_d = null === weather || void 0 === weather ? void 0 : weather.stationInfo) || void 0 === _d ? void 0 : _d.distanceFrom)) {
                    const stringFormat = {
                ...
                let tooltipText = "";
                if (null != (null === (_e = null === weather || void 0 === weather ? void 0 : weather.stationInfo) || void 0 === _e ? void 0 : _e.name)) tooltipText = _("Station Name: {stationName}", {
                    stationName: weather.stationInfo.name
                });
                if (null != (null === (_f = null === weather || void 0 === weather ? void 0 : weather.stationInfo) || void 0 === _f ? void 0 : _f.area)) {
                    tooltipText += ", ";
                    tooltipText += _("Area: {stationArea}", {
                        stationArea: weather.stationInfo.area
                    });
                }
                null === (_g = this.timestampTooltip) || void 0 === _g ? void 0 : _g.set_text(tooltipText);
                if (!shouldShowToggle || config._alwaysShowHourlyWeather) this.HideHourlyToggle(); else this.ShowHourlyToggle();
                return true;
            }
            Destroy() {
                var _a;
                this.actor.destroy_all_children();
                null === (_a = this.timestampTooltip) || void 0 === _a ? void 0 : _a.destroy();
            }
            Rebuild(config) {
                this.Destroy();
                this._timestamp = new uiBar_Button({
                    label: "Placeholder"
                });
                ...
                if (this.app.GetMaxHourlyForecasts() <= 0) this.HideHourlyToggle();
                this.providerCreditButton = new WeatherButton({
                    label: _(ELLIPSIS),
                    reactive: true
                });
            ...
            HideHourlyToggle() {
                var _a;
                null === (_a = this.hourlyButton) || void 0 === _a ? void 0 : _a.actor.hide();
            }
            ShowHourlyToggle() {
                var _a;
                null === (_a = this.hourlyButton) || void 0 === _a ? void 0 : _a.actor.show();
            }
        }
        ...
        class UI {
            constructor(app, orientation) {
                ...
                this.OnConfigChanged = (config, confChange, data) => {
                    if (null == this.App.Provider) return;
            ...
            Toggle() {
                if (!this.noHourlyWeather && this.App.config._alwaysShowHourlyWeather) if (this.menu.isOpen) this.menu.close(true); else {
                    this.menu.open(false);
                    this.ShowHourlyWeather(false);
                    this.menu.close(false);
                    this.menu.open(true);
                } else {
                    if (this.HourlyWeather.Toggled && !this.menu.isOpen) this.HideHourlyWeather(false);
                    this.menu.toggle();
                }
            }
            async ToggleHourlyWeather() {
                if (this.HourlyWeather.Toggled) await this.HideHourlyWeather(); else await this.ShowHourlyWeather();
            }
            Rebuild(config) {
                this.ShowLoadingUi();
            ...
            UpdateIconType(iconType) {
                if (iconType == ui_IconType.FULLCOLOR && this.App.config._useCustomMenuIcons) return;
            ...
            Display(weather, config, provider) {
                ...
                if (!shouldShowToggle) this.ForceHideHourlyWeather();
            ...
            OnThemeChanged() {
                ...
                if (newThemeIsLight != this.lightTheme) this.lightTheme = newThemeIsLight;
                this.App.RefreshAndRebuild();
            }
            ...
            IsLightTheme() {
                ...
                let luminance = (2126 * color.red + 7152 * color.green + 722 * color.blue) / 1e4 / 255;
                luminance = Math.abs(1 - luminance);
                logger_Logger.Debug("Theme is Light: " + (luminance > .5));
                return luminance > .5;
            }
            ForegroundColor() {
            ...
            GetTextColorStyle() {
                let hexColor = null;
                if (this.lightTheme) hexColor = ShadeHexColor(this.ForegroundColor().to_string().substring(0, 7), -.4);
            ...
            async OnDayClicked(sender, date) {
                ...
                if (!wasOpen) await this.ShowHourlyWeather();
                ...
                if (null != newIndex) this.HourlyWeather.ScrollTo(newIndex, wasOpen);
            }
        ...
        function AddHeadersToMessage(message, headers) {
            if (null != headers) for (const key in headers) message.request_headers.append(key, headers[key]);
        }
        class Soup3 {
            constructor() {
            ...
            async Send(url, params, headers, method = "GET") {
                ...
                const data = await new Promise(((resolve, reject) => {
                    ...
                    if (null == message) resolve(null); else {
                        ...
                        this._httpSession.send_and_read_async(message, PRIORITY_DEFAULT, null, ((session, result) => {
                            ...
                            resolve({
                                reason_phrase: null !== (_a = message.get_reason_phrase()) && void 0 !== _a ? _a : "",
                                status_code: message.get_status(),
                                response_body: null != res ? soupLib_ByteArray.toString(soupLib_ByteArray.fromGBytes(res)) : null,
                    ...
                    if (null == message) resolve(null); else {
                        ...
                        this._httpSession.queue_message(message, ((session, message) => {
                            ...
                            resolve({
                                ...
                                response_body: null !== (_b = null === (_a = message.response_body) || void 0 === _a ? void 0 : _a.data) && void 0 !== _b ? _b : null,
                                response_headers: headers
                            });
                        }));
                    }
        ...
        const soupLib = 3 == imports.gi.Soup.MAJOR_VERSION ? new Soup3 : new Soup2;
        // CONCATENATED MODULE: ./src/3_8/lib/httpLib.ts
        class HttpLib {
            static get Instance() {
                if (null == this.instance) this.instance = new HttpLib;
                return this.instance;
            }
            async LoadJsonAsync(url, params, headers, method = "GET") {
                ...
                try {
                    ...
                    if (response.Success) {
                        if (e instanceof Error) logger_Logger.Error("Error: API response is not JSON. The response: " + response.Data, e);
            ...
            async LoadAsync(url, params, headers, method = "GET") {
                ...
                if (!message) error = {
                    ...
                    response: void 0
                }; else if (message.status_code < 100 && message.status_code >= 0) error = {
                    code: message.status_code,
                    message: "no network response",
                    reason_phrase: message.reason_phrase,
                    response: message
                }; else if (message.status_code > 300 || message.status_code < 200) error = {
                    code: message.status_code,
                    message: "bad status code",
                    reason_phrase: message.reason_phrase,
                    response: message
                }; else if (!message.response_body) error = {
                    code: message.status_code,
                    message: "no response data",
                    reason_phrase: message.reason_phrase,
                    response: message
                };
                if ((null !== (_a = null === message || void 0 === message ? void 0 : message.status_code) && void 0 !== _a ? _a : -1) > 200 && (null !== (_b = null === message || void 0 === message ? void 0 : message.status_code) && void 0 !== _b ? _b : -1) < 300) logger_Logger.Info("Warning: API returned non-OK status code '" + (null === message || void 0 === message ? void 0 : message.status_code) + "'");
                logger_Logger.Verbose("API full response: " + (null === (_c = null === message || void 0 === message ? void 0 : message.response_body) || void 0 === _c ? void 0 : _c.toString()));
                if (null != error) logger_Logger.Info("Error calling URL: " + error.reason_phrase + ", " + (null === (_d = null === error || void 0 === error ? void 0 : error.response) || void 0 === _d ? void 0 : _d.response_body));
                return {
                    Success: null == error,
                    Data: null !== (_e = null === message || void 0 === message ? void 0 : message.response_body) && void 0 !== _e ? _e : null,
                    ResponseHeaders: null === message || void 0 === message ? void 0 : message.response_headers,
                    ErrorData: error,
                    Response: message
                };
            }
        ...
        class WeatherApplet extends TextIconApplet {
            ...
            get Refreshing() {
                if (null == this.refreshing) return Promise.resolve();
            ...
            constructor(metadata, orientation, panelHeight, instanceId) {
                ...
                this.RefreshLabel = () => {
                    if (null == this.currentWeatherInfo) return;
                    this.DisplayWeatherOnLabel(this.currentWeatherInfo);
                };
                this.saveLog = async () => {
                    var _a;
                    if (!((null === (_a = this.config._selectedLogPath) || void 0 === _a ? void 0 : _a.length) > 0)) return;
                    let logLines = [];
                    try {
                        logLines = await logger_Logger.GetAppletLogs();
                    } catch (e) {
                        if (e instanceof Error) NotificationService.Instance.Send(_("Error Saving Debug Information"), e.message);
                        return;
                    }
                    let settings = null;
                    try {
                    ...
                    NotificationService.Instance.Send(_("Debug Information saved successfully"), _("Saved to {filePath}", {
                        filePath: this.config._selectedLogPath
                    }));
                };
                this.AfterRefresh = callback => async (owner, data) => {
                    await this.Refreshing;
                    const weatherData = this.CurrentData;
                    if (null == weatherData) return;
            ...
            Locked() {
                return null != this.refreshing;
            }
            async Lock() {
                if (null != this.refreshing) await this.refreshing;
            ...
            Unlock() {
                var _a;
                null === (_a = this.unlockFunc) || void 0 === _a ? void 0 : _a.call(this);
                this.unlockFunc = null;
                this.refreshing = null;
            ...
            async RefreshWeather(rebuild, location = null, manual = true) {
                try {
                    ...
                    if (!this.ui.Display(weatherInfo, this.config, this.provider) || !this.DisplayWeather(weatherInfo)) {
                        this.Unlock();
                        return "fail";
                    }
                    ...
                    if (e instanceof Error) logger_Logger.Error("Generic Error while refreshing Weather info: " + e + ", ", e);
                    this.ShowError({
                        type: "hard",
                        detail: "unknown",
                        message: _("Unexpected Error While Refreshing Weather, please see log in Looking Glass")
                    });
                    this.Unlock();
                    return "fail";
                }
            ...
            DisplayWeatherOnLabel(weather) {
                ...
                if (this.Orientation != main_Side.LEFT && this.Orientation != main_Side.RIGHT) {
                    if (this.config._showCommentInPanel) label += mainCondition;
                    if (this.config._showTextInPanel) {
                        if ("" != label) label += " ";
                        label += TempToUserConfig(temperature, this.config);
                    }
                } else if (this.config._showTextInPanel) {
                    label = null !== (_a = TempToUserConfig(temperature, this.config, false)) && void 0 !== _a ? _a : "";
                    if (this.GetPanelHeight() >= 35) label += UnitToUnicode(this.config.TemperatureUnit);
                }
                if (NotEmpty(this.config._panelTextOverride)) label = InjectValues(this.config._panelTextOverride, weather, this.config);
            ...
            SetAppletTooltip(weather, config, override) {
                ...
                let msg = `${location} - ${_("As of {lastUpdatedTime}", {
                    lastUpdatedTime
                })}`;
                if (NotEmpty(override)) msg = InjectValues(override, weather, config);
                this.set_applet_tooltip(msg);
            }
            SetAppletIcon(iconNames, customIcon) {
                if (this.config._useCustomAppletIcons) this.SetCustomIcon(customIcon); else {
                    const icon = WeatherIconSafely(iconNames, this.config.AppletIconType);
                    this.config.AppletIconType == main_IconType.SYMBOLIC ? this.set_applet_icon_symbolic_name(icon) : this.set_applet_icon_name(icon);
                }
            }
            ...
            GetPanelHeight() {
                var _a, _b;
                return null !== (_b = null === (_a = this.panel) || void 0 === _a ? void 0 : _a.height) && void 0 !== _b ? _b : 0;
            }
            GetMaxForecastDays() {
            ...
            async LoadJsonAsyncWithDetails(url, params, HandleError, headers, method = "GET") {
                ...
                if (!response.Success) if (!!HandleError && !HandleError(response)) return response; else {
            ...
            async LoadAsync(url, params, HandleError, headers, method = "GET") {
                ...
                if (!response.Success) if (!!HandleError && !HandleError(response)) return null; else {
                    this.HandleHTTPError(response.ErrorData);
                    return null;
                }
            ...
            async submitIssue() {
                ...
                const distribution = null === (_b = null === (_a = await SpawnProcess([ "uname", "-vrosmi" ])) || void 0 === _a ? void 0 : _a.Data) || void 0 === _b ? void 0 : _b.trim();
                const appletVersion = this.metadata.version;
                const cinnamonVersion = imports.misc.config.PACKAGE_VERSION;
                const vgaInfo = null === (_c = (await SpawnProcess([ "lspci" ])).Data) || void 0 === _c ? void 0 : _c.split("\n").filter((x => x.includes("VGA")));
                let body = "```\n";
            ...
            EnsureProvider(force = false) {
                var _a;
                const currentName = null === (_a = this.provider) || void 0 === _a ? void 0 : _a.name;
                if (currentName != this.config._dataService || force) this.provider = ServiceClassMapping[this.config._dataService](this);
            }
            MergeWeatherData(weatherInfo, locationData) {
                if (null == weatherInfo.location.city) weatherInfo.location.city = locationData.city;
                if (null == weatherInfo.location.country) weatherInfo.location.country = locationData.country;
                if (null == weatherInfo.location.timeZone) weatherInfo.location.timeZone = locationData.timeZone;
                if (null == weatherInfo.coord.lat) weatherInfo.coord.lat = locationData.lat;
                if (null == weatherInfo.coord.lon) weatherInfo.coord.lon = locationData.lon;
                if (null == weatherInfo.hourlyForecasts) weatherInfo.hourlyForecasts = [];
            ...
            ShowError(error) {
                ...
                if (true == this.encounteredError) return;
                ...
                if ("soft" == error.type) if (this.loop.IsDataTooOld()) {
                    this.set_applet_tooltip("Click to open");
                    this.set_applet_icon_name("weather-severe-alert");
